...
namespace EJ2MVCSampleBrowser.Controllers.Diagram {
        public partial class DiagramController: Controller {
                ...
                public ActionResult Nodes() {
                        ...
                        SymbolPaletee.Add(new FlowShapes() {
                            Id = "Document", Shape = new {
                                type = "Flow", shape = "Document"
                            }
                        });
                        SymbolPaletee.Add(new FlowShapes() {
                            Id = "PreDefinedProcess", Shape = new {
                                type = "Flow", shape = "PreDefinedProcess"
                            }
                        });
                        SymbolPaletee.Add(new FlowShapes() {
                            Id = "PaperTap", Shape = new {
                                type = "Flow", shape = "PaperTap"
                            }
                        });
                        SymbolPaletee.Add(new FlowShapes() {
                            Id = "DirectData", Shape = new {
                                type = "Flow", shape = "DirectData"
                            }
                        });
                        SymbolPaletee.Add(new FlowShapes() {
                            Id = "SequentialData", Shape = new {
                                type = "Flow", shape = "SequentialData"
                            }
                        });
                        ...
                        SvgNodes.Add(new DiagramNode() {
                                    Id = "Sync", Style = new NodeStyleNodes() {
                                        ...
                                        SvgNodes.Add(new DiagramNode() {
                                            Id = "Network", Style = new NodeStyleNodes() {
                                        ...
                                        ViewBag.SvgShapes = SvgNodes;

                                        List < DiagramNode > HtmlNodes = new List < DiagramNode > ();
                                        HtmlNodes.Add(new DiagramNode() {
                                            Id = "Button", Shape = new {
                                                type = "HTML", content = "<div style="
                                                height: 100 % ;
                                                width: 100 % ;
                                                "><button type="
                                                button " style="
                                                width: 100 % ;
                                                overflow: hidden ">HTML</button></div>"
                                            }
                                        });
                                        HtmlNodes.Add(new DiagramNode() {
                                                Id = "Checkbox", Shape = new {
                                                    type = "HTML", content = "<div><div style="
                                                    height: 50 % ;
                                                    width: 100 % ;
                                                    "><input type="
                                                    checkbox " value="
                                                    Yes " style="
                                                    width: 25 % ">Yes</input></div>' +
                                                    '<div style="height:50%;width:100%;"><input type="checkbox" value="No" style="width:25%">No</input></div></div>"}
                                                }); HtmlNodes.Add(new DiagramNode() {
                                                Id = "Dropdown", Shape = new {
                                                    type = "HTML", content = "<<div style="
                                                    height: 100 % ;
                                                    width: 100 % ;
                                                    "><select style="
                                                    width: 100 % "><option>SVG</option><option>Canvas</option></select></div>"
                                                }
                                            }); ViewBag.HtmlShapes = HtmlNodes;


                                            List < DiagramConnector > connector = new List < DiagramConnector > (); connector.Add(new DiagramConnector() {
                                            ...
                                            List < SymbolPalettePalette > palettes = new List < SymbolPalettePalette > (); palettes.Add(new SymbolPalettePalette() {
                                            ...
                                            palettes.Add(new SymbolPalettePalette() { Id="svg", Expanded = true, symbols = SvgNodes, Title = "SVG Shapes" });
                                            palettes.Add(new SymbolPalettePalette() { Id="html", Expanded = true, symbols = HtmlNodes, Title = "HTML Shapes" });
                                            palettes.Add(new SymbolPalettePalette() {
