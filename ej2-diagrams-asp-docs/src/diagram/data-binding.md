...
{% aspTab template="diagram/data-binding/local", sourceFiles="local.cs" %}
...
{% aspTab template="diagram/data-binding/insertdata", sourceFiles="insertdata.cs" %}
...
{% aspTab template="diagram/data-binding/updatedata", sourceFiles="updatedata.cs" %}
...
{% aspTab template="diagram/data-binding/deletedata", sourceFiles="deletedata.cs" %}
