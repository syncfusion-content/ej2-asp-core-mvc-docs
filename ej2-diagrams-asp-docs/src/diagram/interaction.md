...
>Note: For connector editing, you have to inject the [`ConnectorEditing`](https://ej2.syncfusion.com/documentation/api/diagram/connectorEditing) module.
...
{% aspTab template="diagram/interaction/click", sourceFiles="click.cs" %}
...
{% aspTab template="diagram/interaction/panstatus", sourceFiles="panstatus.cs" %}
