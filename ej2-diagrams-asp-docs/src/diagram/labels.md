...
{% aspTab template="diagram/annotation/annotationRender", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/updateAnnotation", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/annotationOffset", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/HVAlignAnnotation", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/annotationSegment", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/annotationMargin", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/annotationTextAlign", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/hyperLink", sourceFiles="hyperLink.cs" %}
...
{% aspTab template="diagram/annotation/labelTemplate", sourceFiles="labelTemplate.cs" %}
...
{% aspTab template="diagram/annotation/textWrapping", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/textOverFlow", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/appearance", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/appearanceStyle", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/readOnly", sourceFiles="annotation.cs" %}
...
{% aspTab template="diagram/annotation/dragLimit", sourceFiles="dragLimit.cs" %}
...
{% aspTab template="diagram/annotation/multiAnnotation", sourceFiles="annotation.cs" %}
