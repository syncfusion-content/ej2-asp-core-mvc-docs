...
{% aspTab template="pivot-table/action-event/actionBegin-editing", sourceFiles="actionBegin-editing.cs" %}
...
{% aspTab template="pivot-table/action-event/actionComplete-editing", sourceFiles="actionComplete-editing.cs" %}
...
{% aspTab template="pivot-table/action-event/actionFailure-editing", sourceFiles="actionFailure-editing.cs" %}
