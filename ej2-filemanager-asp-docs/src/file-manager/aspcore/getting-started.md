...
{% aspTab template="file-manager/getting-started", sourceFiles="HomeController_core.cs" %}
...
{% aspTab template="file-manager/overview", sourceFiles="HomeController_core.cs" %}
...
{% aspTab template="file-manager/view", sourceFiles="HomeController_core.cs" %}
...
{% aspTab template="file-manager/persistence", sourceFiles="HomeController_core.cs" %}
...
{% aspTab template="file-manager/rtl", sourceFiles="HomeController_core.cs" %}
...
{% aspTab template="file-manager/path", sourceFiles="HomeController_core.cs" %}
