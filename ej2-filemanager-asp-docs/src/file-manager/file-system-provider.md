...
{% aspTab template="file-manager/file-system-provider" %}
...
> **Note:** To learn more about the file actions that can be performed with Amazon S3 Cloud File System provider, refer to this [link](https://github.com/SyncfusionExamples/amazon-s3-aspcore-file-provider#key-features)
...
{% aspTab template="file-manager/fire-base" %}
