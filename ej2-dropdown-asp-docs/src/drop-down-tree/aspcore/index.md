...
description: "The Syncfusion ASP.NET Core drop-down tree control displays a hierarchical data in a tree-like structure from which the use can select one or more items."
---
