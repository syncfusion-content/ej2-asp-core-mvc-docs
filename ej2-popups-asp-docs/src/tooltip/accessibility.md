...
component: "Tooltip"
description: "Tooltip component has accessibility support to help access the features via keyboard, on-screen readers, or other assistive technology devices."
---
...
{% aspTab template="tooltip/accessibility", sourceFiles="accessibility.cs" %}
