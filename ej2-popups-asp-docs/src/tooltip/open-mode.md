...
{% aspTab template="tooltip/open-mode", sourceFiles="open-mode.cs" %}
...
{% aspTab template="tooltip/custom-mode", sourceFiles="custom-mode.cs" %}
...
{% aspTab template="tooltip/sticky-mode", sourceFiles="sticky-mode.cs" %}
...
{% aspTab template="tooltip/delay-mode", sourceFiles="delay-mode.cs" %}
