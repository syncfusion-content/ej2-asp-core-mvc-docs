---
title: "ProgressBar Getting Started | ASP.NET CORE"

component: "ProgressBar"

description: "Getting started file explains how to configure and install progress bar packages and also how to create basic progress bar, module injections."
---
...
{% aspTab template="progress-bar/getting-started/default" %}
