...
description: Customize Syncfusion ##Platform_Name## InplaceEditor popup-mode open and close animation by configuring Tooltip properties on the model inside popupSettings API.
