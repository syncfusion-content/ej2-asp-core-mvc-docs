...
N> You can also explore our [ASP.NET Core In-place Editor example](https://ej2.syncfusion.com/aspnetcore/inplaceeditor/defaultfunctionalities#/fluent2) that shows you how to render and configure the In-place Editor.