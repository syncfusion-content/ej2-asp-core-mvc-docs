...
description: Auto-open Syncfusion ##Platform_Name## InplaceEditor edit mode on page load by setting the enableEditMode property to true without needing user interaction.
