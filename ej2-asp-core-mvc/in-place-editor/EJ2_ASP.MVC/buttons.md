...
description: Customize the Syncfusion ##Platform_Name## InplaceEditor save and cancel buttons using the saveButton and cancelButton accept ButtonModel objects.
