...
description: Bind Syncfusion ##Platform_Name## InplaceEditor to local arrays or remote data services using the dataSource property with DataManager, OData, and Web API.
