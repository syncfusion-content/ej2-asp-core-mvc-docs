...
description: Customize the Syncfusion ##Platform_Name## Signature component by configuring stroke width, stroke color, background color, and background images.
