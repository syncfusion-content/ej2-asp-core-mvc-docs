public IActionResult Index()
        {
            List<object> Price = new List<object>()
            {
                ...
                new { ItemName= "Running Shoes",  Date= "02/04/2014",  Time= "03:44:34 AM", Quantity= 40, Price= 20, Amount= 800, Discount= 13, Profit= 66 },
            ...
            ViewBag.DefaultData = Price;
            ViewBag.autoFillSettings = new autoFillSettings { fillType = "FillSeries", showFillOptions = true };
            return View();
        }
class autoFillSettings { public string fillType; public bool showFillOptions; }
