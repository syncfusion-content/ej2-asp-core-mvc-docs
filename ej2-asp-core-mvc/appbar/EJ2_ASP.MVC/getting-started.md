...
## Add ASP.NET MVC AppBar control

Now, add the Syncfusion ASP.NET MVC AppBar control in `~/Home/Index.cshtml` page.

{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}

<div class="col-lg-12 control-section default-appbar-section">
    @(Html.EJS().AppBar("defaultAppBar").ColorMode(Syncfusion.EJ2.Navigations.AppBarColor.Primary).ContentTemplate(@<div>
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the app. Then, the Syncfusion ASP.NET MVC AppBar control will be rendered in the default web browser.
