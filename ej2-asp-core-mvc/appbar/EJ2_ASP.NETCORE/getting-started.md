...
description: Get started with the Syncfusion ASP.NET Core AppBar by adding the Navigations NuGet package and rendering a top app bar in a Razor Pages app.
