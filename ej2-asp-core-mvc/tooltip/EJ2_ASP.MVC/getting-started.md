---
layout: post
title: Getting Started with ASP.NET MVC Tooltip | Syncfusion
description: Learn how to get started with the Syncfusion ASP.NET MVC Tooltip control. Explore setup, configuration, populated content, and rendering examples.
...
# Getting Started with ASP.NET MVC Tooltip
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC Tooltip control will be rendered in the default web browser.

![ASP.NET MVC Tooltip Control](images/tooltip.png)

## Initialize Tooltip within a container

You can create Tooltips on multiple targets within a container. To do so, you have to define specific target elements to the [Target](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Popups.Tooltip.html#Syncfusion_EJ2_Popups_Tooltip_Target) property so that the Tooltip is initialized only on matched targets within a container. In this case, the Tooltip content is assigned from the `title` attribute of the target element.
...
N> [View Sample in GitHub](https://github.com/SyncfusionExamples/ASP-NET-MVC-Getting-Started-Examples/tree/main/Tooltip/ASP.NET%20MVC%20Razor%20Examples).
