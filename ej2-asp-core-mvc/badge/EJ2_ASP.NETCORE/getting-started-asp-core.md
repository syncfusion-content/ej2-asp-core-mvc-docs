...
N> You can also explore our [ASP.NET Core Badge example](https://ej2.syncfusion.com/aspnetcore/badge/default#/fluent2) that shows you how to render and configure the Badge.