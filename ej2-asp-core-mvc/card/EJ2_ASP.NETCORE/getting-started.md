...
N> You can also explore our [ASP.NET Core Card example](https://ej2.syncfusion.com/aspnetcore/card/basiccard#/fluent2) that shows you how to render and configure the Card.