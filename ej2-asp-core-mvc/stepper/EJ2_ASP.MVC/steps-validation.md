...
description: Learn how to validate steps in the Syncfusion ##Platform_Name## Stepper by displaying success and error states using step validation settings.
...
# Validation in ##Platform_Name## Stepper
