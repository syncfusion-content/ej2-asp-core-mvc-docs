---
layout: post
title: Getting Started with ##Platform_Name## Button Group Control
...
Now, add the Syncfusion ASP.NET Core Button Group tag helper in `~/Pages/Index.cshtml` page.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion ASP.NET Core Button Group control will be rendered in the default web browser.
