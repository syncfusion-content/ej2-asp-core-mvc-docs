...
description: Customize ASP.NET MVC Button Group visuals by overriding .e-btn CSS classes for hover, focus, and active states.
...
# Style and Appearance in ##Platform_Name## Button Group
