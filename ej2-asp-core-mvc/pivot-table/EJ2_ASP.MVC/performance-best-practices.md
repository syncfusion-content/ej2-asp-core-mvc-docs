...
description: Learn how the ASP.NET MVC Pivot Table handles large datasets and complex reports with performance tips like virtual scrolling, paging, and data compression.
...
Performance optimization is crucial when working with large datasets in the [Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC Pivot Table](https://www.syncfusion.com/aspnet-mvc-ui-controls/pivot-table). This documentation provides best practices to support your data analysis and to enhance the user experience.
