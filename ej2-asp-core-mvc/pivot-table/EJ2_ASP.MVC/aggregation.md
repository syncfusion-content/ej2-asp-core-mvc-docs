...
{% aspTab template="pivot-table/action-event/actionBegin-aggregation", sourceFiles="actionBegin-aggregation.cs" %}
...
{% aspTab template="pivot-table/action-event/actionComplete-aggregation", sourceFiles="actionComplete-aggregation.cs" %}
...
{% aspTab template="pivot-table/action-event/actionFailure-aggregation", sourceFiles="actionFailure-aggregation.cs" %}
