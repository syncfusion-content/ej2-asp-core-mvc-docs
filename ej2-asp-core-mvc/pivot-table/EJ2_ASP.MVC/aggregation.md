...
description: Learn how the ASP.NET MVC Pivot Table aggregates grouped values using built-in types like Sum, Count, Average, Min, Max, Product, Median, and more.
...
> Numeric fields support all aggregation types listed below. Fields of type string, date, datetime, boolean, and similar types support only [**SummaryTypes.Count**](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.PivotView.SummaryTypes.html) and **DistinctCount** aggregation.
...
> By default, the aggregation is set to [**SummaryTypes.Sum**](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.PivotView.SummaryTypes.html) for value fields that have a number type, and to [**SummaryTypes.Count**](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.PivotView.SummaryTypes.html) for value fields that have non-number type values such as string, date, datetime, boolean, and so on.
