...
description: Learn how the ASP.NET MVC Pivot Table renders only the visible rows and columns via EnableVirtualization and the VirtualScroll module, for smooth scrolling on large datasets.
