...
{% aspTab template="pivot-table/action-event/actionBegin-fieldList", sourceFiles="actionBegin-fieldList.cs" %}
...
{% aspTab template="pivot-table/action-event/actionComplete-fieldList", sourceFiles="actionComplete-fieldList.cs" %}
...
{% aspTab template="pivot-table/action-event/actionFailure-fieldList", sourceFiles="actionFailure-fieldList.cs" %}
