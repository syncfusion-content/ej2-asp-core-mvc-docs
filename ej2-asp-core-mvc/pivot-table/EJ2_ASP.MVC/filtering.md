...
{% aspTab template="pivot-table/action-event/actionBegin-filter", sourceFiles="actionBegin-filter.cs" %}
...
{% aspTab template="pivot-table/action-event/actionComplete-filter", sourceFiles="actionComplete-filter.cs" %}
...
{% aspTab template="pivot-table/action-event/actionFailure-filter", sourceFiles="actionFailure-filter.cs" %}
