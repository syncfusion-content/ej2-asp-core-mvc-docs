...
description: Learn how the ASP.NET MVC Pivot Table filters rows and columns using member, label, and value filtering for focused data analysis.
...
* [`Cancel`](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.CancelEventArgs.html) - A Boolean property that stops the filter from being applied when set to `true`.
...
* `dataSourceSettings` - Holds the updated [`DataSourceSettings`](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.PivotView.PivotViewDataSourceSettings.html) after the filter is applied.
