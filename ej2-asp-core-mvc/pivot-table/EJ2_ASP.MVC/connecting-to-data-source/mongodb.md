...
# MongoDB Data Binding in ASP.NET MVC Pivot Table
...
2. The application is typically hosted at `https://localhost:44346/` (the port number may vary based on your configuration). Note the exact URL printed by the runtime so you can reference it from the ASP.NET MVC project.
