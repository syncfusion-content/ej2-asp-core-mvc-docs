...
{% aspTab template="action-event/actionBegin-calculatedField", sourceFiles="actionBegin-calculatedField.cs" %}
...
{% aspTab template="action-event/actionComplete-calculatedField", sourceFiles="actionComplete-calculatedField.cs" %}
...
{% aspTab template="action-event/actionFailure-calculatedField", sourceFiles="actionFailure-calculatedField.cs" %}
