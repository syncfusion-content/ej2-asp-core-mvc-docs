---
layout: post
title: How to Customize the Loading Indicator in ASP.NET MVC Pivot Table | Syncfusion
description: Learn how to customize the ASP.NET MVC Pivot Table's loading spinner via the SpinnerTemplate property, accepting an HTML string for custom styling and animations.
