---
layout: post
title: How to Configure Data Grid Options on Editing Mode in ASP.NET MVC Pivot Table | Syncfusion
description: Learn how to configure sort, group, and filter on the ASP.NET MVC Pivot Table's drill-through data grid via the BeginDrillThrough event handler before popup render.
...
# How to Configure Data Grid Options on Editing Mode in ASP.NET MVC Pivot Table
