---
layout: post
title: Label Filtering in ##Platform_Name## Pivot Table Component
description: Learn here all about Label Filtering in Syncfusion ##Platform_Name## Pivot Table component of Syncfusion Essential JS 2 and more.
