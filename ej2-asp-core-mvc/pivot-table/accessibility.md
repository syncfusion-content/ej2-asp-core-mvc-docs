...
description: Learn how the ##Platform_Name## Pivot Table provides WAI-ARIA roles, keyboard interaction, and screen reader support for WCAG 2.2 and Section 508.
