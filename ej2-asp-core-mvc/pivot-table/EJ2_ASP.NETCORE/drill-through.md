...
description: Learn how the ASP.NET Core Pivot Table shows the raw, unaggregated records behind any aggregated value cell on double-click through the drill-through grid.
...
> [Grid](https://ej2.syncfusion.com/aspnetcore/documentation/grid/getting-started-core) features are segregated into individual feature-wise modules.
