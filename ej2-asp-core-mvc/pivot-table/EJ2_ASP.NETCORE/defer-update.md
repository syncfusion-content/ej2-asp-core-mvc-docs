...
description: Learn how the ASP.NET Core Pivot Table defers report rendering until the user clicks Apply, improving performance during complex Field List drag-drop and filter operations.
