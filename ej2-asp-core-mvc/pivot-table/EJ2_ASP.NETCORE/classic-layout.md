...
description: Learn how the ASP.NET Core Pivot Table's classic (tabular) layout displays row-axis fields side by side in separate columns for easier reading on relational data sources.
