...
description: Learn how the ASP.NET Core Pivot Table renders only the visible rows and columns via enableVirtualization and the VirtualScroll module, for smooth scrolling on large datasets.
...
# Virtual Scrolling in ASP.NET Core Pivot Table
