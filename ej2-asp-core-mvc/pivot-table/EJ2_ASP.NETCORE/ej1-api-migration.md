...
description: Learn how to migrate Pivot Grid API usage from Essential JS 1 to the ASP.NET Core Pivot Table by mapping data source, rows, columns, values, and filter properties.
