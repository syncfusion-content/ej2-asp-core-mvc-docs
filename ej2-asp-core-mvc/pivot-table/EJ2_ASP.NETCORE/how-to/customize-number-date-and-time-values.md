---
layout: post
title: How to Customize Number, Date, and Time Values in ASP.NET Core Pivot Table | Syncfusion
description: Learn how to apply number, date, and time formats to ASP.NET Core Pivot Table fields via e-formatsettings, including currency, percentage, and Intl numberFormatOptions.
...
# How to Customize Number, Date, and Time Values in ASP.NET Core Pivot Table
