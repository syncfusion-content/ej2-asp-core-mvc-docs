...
description: Learn how the ASP.NET Core Pivot Table handles large datasets and complex reports with performance tips like virtual scrolling, paging, and data compression.
...
Performance optimization is crucial when working with large datasets in the [ASP.NET Core Pivot Table](https://www.syncfusion.com/aspnet-core-ui-controls/pivot-table). This documentation provides best practices to support your data analysis and to enhance the user experience.
