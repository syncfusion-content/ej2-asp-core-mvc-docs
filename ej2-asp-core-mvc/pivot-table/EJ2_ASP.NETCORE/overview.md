...
description: Explore the ASP.NET Core Pivot Table overview and feature matrix for data analysis, data sources, layouts, performance, exporting, accessibility, and AI integration.
control: Pivot Table
...
# Overview of ASP.NET Core Pivot Table

The Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Pivot Table provides interactive tools for summarizing, organizing, exploring, and presenting multidimensional data. Use the following feature overview to identify the available capabilities, understand where they apply, and open the corresponding user guide topic for configuration details and limitations.

For supported ASP.NET Core and browser versions, refer to the [system requirements](https://ej2.syncfusion.com/aspnetcore/documentation/system-requirements).
...
| Touch interaction and mobile-device support | Built-in | Relational and OLAP | [Accessibility](../accessibility) and [touch support](https://www.syncfusion.com/aspnet-core-ui-controls/pivot-table#touch-support) |
...
| High Contrast theme support | Configurable | Component UI | [Themes](https://ej2.syncfusion.com/aspnetcore/documentation/appearance/theme) |
...
* [Live Pivot Table demos](https://ej2.syncfusion.com/aspnetcore/pivottable/overview#/fluent2)
* [Pivot Table API reference](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.PivotView.html/)
* [Release notes](https://ej2.syncfusion.com/aspnetcore/documentation/release-notes/)
