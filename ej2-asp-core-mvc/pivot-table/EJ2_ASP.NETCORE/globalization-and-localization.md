...
For more details:
- Learn about [`Internationalization`](https://ej2.syncfusion.com/aspnetcore/documentation/common/internationalization) for formatting dates and numbers.
- Read about [`Localization`](https://ej2.syncfusion.com/aspnetcore/documentation/common/localization) for translating text content.
...
N> * In the above sample, `Amount` field is formatted by [`NumberFormatOptions`](https://ej2.syncfusion.com/aspnetcore/documentation/common/internationalization#manipulating-numbers). For date formats, the value strings are formatted by [`DateFormatOptions`](https://ej2.syncfusion.com/aspnetcore/documentation/common/internationalization#manipulating-datetime).
* By default, `locale` value is `en-US`. If you want to change the `en-US` culture to a different culture, you have to change the `locale` accordingly.
* You can find more details about supported format strings for number formats and date formats [`here`](https://ej2.syncfusion.com/aspnetcore/documentation/common/internationalization#supported-format-string).

<!-- markdownlint-disable MD009 -->

### Decimal separators

The Pivot Table automatically adjusts decimal separators in numeric values to match your selected culture, making data easier to read for users from different regions. You can set the culture by calling the [`setCulture`](https://ej2.syncfusion.com/aspnetcore/documentation/common/internationalization/?no-cache=1#setting-global-culture) method with the appropriate culture string as its parameter. Once applied, all numeric values in the Pivot Table will display using the decimal separator convention of that culture.
...
The [`Localization`](https://ej2.syncfusion.com/aspnetcore/documentation/common/localization) option allows you to translate the default text content of the Pivot Table into different languages. This makes the component more accessible to users from various regions by displaying text in their preferred language.
...
To load translation content in your application, use the [`load`](https://ej2.syncfusion.com/documentation/common/api-l10n.html#loadhttpsej2comcommon/-.html#load) method of the [`L10n`](https://ej2.syncfusion.com/documentation/common/api-l10n.html) class. This method accepts translation objects that contain text content in different languages.
