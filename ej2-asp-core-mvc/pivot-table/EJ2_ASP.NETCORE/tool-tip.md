...
description: Learn how the ASP.NET Core Pivot Table displays contextual tooltips on value cells via the showTooltip property, including row and column header info on hover.
