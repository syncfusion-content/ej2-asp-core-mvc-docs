...
description: Learn how the ASP.NET Core Pivot Table exposes a grouping bar for dragging, dropping, filtering, and sorting fields interactively at runtime.
...
The grouping bar offers additional options to modify its appearance and behavior using the [`e-groupingBarSettings`](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.PivotView.PivotViewGroupingBarSettings.html) property. The available sub-properties are summarized below:
