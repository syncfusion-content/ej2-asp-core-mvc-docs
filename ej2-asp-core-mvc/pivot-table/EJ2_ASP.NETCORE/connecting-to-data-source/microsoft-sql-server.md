---
layout: post
title: Microsoft SQL Server Data Binding in ASP.NET Core Pivot Table | Syncfusion
description: Learn how to bind Microsoft SQL Server data to the ASP.NET Core Pivot Table using SqlClient in a Web API controller, with a sample PivotController and Database1.mdf.
...
# Microsoft SQL Server Data Binding in ASP.NET Core Pivot Table
