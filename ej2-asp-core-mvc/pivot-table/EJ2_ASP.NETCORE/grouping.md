...
![Context-menu options for number grouping](../pivot-table/images/number-group-option.webp)
...
![Range options applied for number grouping](../pivot-table/images/number-group-settings-range-applied.webp)
...
![Grouping settings options applied for number grouping](../pivot-table/images/number-group-settings-applied.webp)
<br/>
![Applied grouping settings updated in pivot table for number grouping](../pivot-table/images/number-group-updated.webp)
...
![Number ungroup option](../pivot-table/images/number-ungroup.webp)
...
![Context-menu options for date grouping](../pivot-table/images/date-group-option.webp)
...
![Range options applied for date grouping](../pivot-table/images/date-group-settings-range-applied.webp)
...
![Group interval option applied for date grouping](../pivot-table/images/date-group-settings-interval-applied.webp)
<br/>

![Grouping settings options applied for date grouping](../pivot-table/images/date-group-settings-applied.webp)
<br/>

![Applied grouping settings updated in pivot table for date grouping](../pivot-table/images/date-group-updated.webp)
...
![Date ungroup option](../pivot-table/images/date-ungroup.webp)
...
![Context-menu options for custom grouping](../pivot-table/images/custom-group-option.webp)
...
![Caption applied for custom grouping](../pivot-table/images/custom-group-settings-caption-applied.webp)
<br/>

![Grouping settings applied for custom grouping](../pivot-table/images/custom-group-settings-applied.webp)
<br/>

![Applied grouping settings updated in pivot table for custom grouping](../pivot-table/images/custom-group-updated.webp)
...
![Context-menu options for nested custom grouping](../pivot-table/images/nested-custom-group-option.webp)
<br/>

![Grouping settings applied for nested custom grouping](../pivot-table/images/nested-custom-group-settings-applied.webp)
<br/>

![Applied grouping settings updated in pivot table for custom grouping](../pivot-table/images/nested-custom-group-updated.webp)
...
![Custom ungroup option](../pivot-table/images/custom-ungroup.webp)
