...
description: Learn how the ##Platform_Name## Pivot Table visualizes relational data with built-in aggregation, filtering, sorting, and Field List, plus Excel and PDF export.
...
# About Syncfusion ##Platform_Name## Pivot Table Component.
