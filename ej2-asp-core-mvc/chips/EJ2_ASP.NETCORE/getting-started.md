...
N> You can also explore our [ASP.NET Core Chips Example](https://ej2.syncfusion.com/aspnetcore/Chips/DefaultFunctionalities#/material) that shows you how to render the Chips in ASP.NET Core.