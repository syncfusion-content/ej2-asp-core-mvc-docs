...
description: Learn here all about Symbol Palette of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="diagram/symbol-palette/palette", sourceFiles="palette.cs" %}
...
{% aspTab template="diagram/symbol-palette/symbols", sourceFiles="symbols.cs" %}
...
{% aspTab template="diagram/symbol-palette/restrict", sourceFiles="restrict.cs" %}
...
{% aspTab template="diagram/symbol-palette/fit", sourceFiles="fit.cs" %}
...
{% aspTab template="diagram/symbol-palette/margin", sourceFiles="margin.cs" %}
...
{% aspTab template="diagram/symbol-palette/preview", sourceFiles="preview.cs" %}
...
{% aspTab template="diagram/symbol-palette/default", sourceFiles="default.cs" %}
...
{% aspTab template="diagram/symbol-palette/description", sourceFiles="description.cs" %}
