...
description: Learn here all about User Handle of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="diagram/interaction/node", sourceFiles="node.cs" %}
...
{% aspTab template="diagram/interaction/fixeduserhandle", sourceFiles="node.cs" %}
...
{% aspTab template="diagram/interaction/customizingfixeduserhandle", sourceFiles="fixeduserhandle.cs" %}
...
{% aspTab template="diagram/interaction/nodefixeduserhandle", sourceFiles="node.cs" %}
...
{% aspTab template="diagram/interaction/connectorfixeduserhandle", sourceFiles="fixeduserhandle.cs" %}
