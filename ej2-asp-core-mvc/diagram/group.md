...
description: Learn here all about Group of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="diagram/group/group", sourceFiles="group.cs" %}
...
{% aspTab template="diagram/group/ungroup", sourceFiles="ungroup.cs" %}
...
{% aspTab template="diagram/group/run", sourceFiles="run.cs" %}
...
{% aspTab template="diagram/group/stack", sourceFiles="stack.cs" %}
