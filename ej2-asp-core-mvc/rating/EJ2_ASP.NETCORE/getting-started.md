...
To add [ASP.NET Core Rating](https://www.syncfusion.com/aspnet-core-ui-controls/rating) control in the app, open the NuGet package manager in Visual Studio *(Tools → NuGet Package Manager → Manage NuGet Packages for Solution)*, search for and install the [Syncfusion.AspNetCore.Inputs](https://www.nuget.org/packages/Syncfusion.AspNetCore.Inputs/) and [Syncfusion.AspNetCore.Themes](https://www.nuget.org/packages/Syncfusion.AspNetCore.Themes/) packages. All Syncfusion ASP.NET Core packages are available on [nuget.org](https://www.nuget.org/packages?q=syncfusion.EJ2). See the [NuGet packages](https://ej2.syncfusion.com/aspnetcore/documentation/nuget-packages) topic for details.
...
## Add ASP.NET Core Rating control

Add the [ASP.NET Core Rating](https://www.syncfusion.com/aspnet-core-ui-controls/rating) control in the **~/Pages/Index.cshtml** file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [ASP.NET Core Rating](https://www.syncfusion.com/aspnet-core-ui-controls/rating) control will render in your default web browser.

![ASP.NET CORE Rating Control](images/rating-control.webp)
...
![Displaying Rating Value in ASP.NET CORE Rating Control](images/rating-value.webp)