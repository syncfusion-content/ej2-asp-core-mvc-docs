...
The Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Grid component allows to reorder columns by drag and drop of a particular column header from one index to another index within the grid.
