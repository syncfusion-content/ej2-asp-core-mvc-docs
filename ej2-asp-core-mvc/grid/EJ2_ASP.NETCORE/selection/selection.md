...
# Selection in ASP.NET Core Data Grid
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid/selection/selection-clear/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid/selection/selection-persist/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="selection.cs" %}
