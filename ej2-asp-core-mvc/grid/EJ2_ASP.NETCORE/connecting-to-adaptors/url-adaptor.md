---
layout: post
title: Bind data and perform CRUD action with UrlAdaptor Syncfusion in ##Platform_Name## Grid Component
...
# UrlAdaptor in Syncfusion ASP.NET Core Grid Control

The UrlAdaptor serves as the base adaptor for facilitating communication between remote data services and an UI control. It enables seamless data binding and interaction with custom API services or any remote service through URLs. The UrlAdaptor is particularly useful for the scenarios where a custom API service with unique logic for handling data and CRUD operations is in place. This approach allows for custom handling of data and CRUD operations, and the resultant data returned in the `result` and `count` format for display in the Syncfusion ASP.NET Core Grid control.

This section describes a step-by-step process for retrieving data using UrlAdaptor, then binding it to the ASP.NET Core Grid control to facilitate data and CRUD operations.
...
Open Visual Studio and create an ASP.NET Core project named **UrlAdaptor_Core**. To create an ASP.NET Core application, follow the documentation [link](https://learn.microsoft.com/en-us/aspnet/core/tutorials/razor-pages/razor-pages-start?view=aspnetcore-8.0&tabs=visual-studio#create-a-razor-pages-web-app) for detailed steps.
...
{% highlight cs tabtitle="OrdersDetails.cs" %}
 ...
 namespace UrlAdaptor_Core.Models
{
...
using UrlAdaptor_Core.Models;

namespace UrlAdaptor_Core.Controllers
{
...
![UrlAdaptor-data](../images/adaptors/url-adaptor-data.jpeg)
...
![UrlAdaptor searching](../images/adaptors/url-adaptor-searching.png)
...
![Single column filtering](../images/adaptors/url-adaptor-filtering.png)

**Multi column filtering**
![Multi column filtering](../images/adaptors/url-adaptor-multi-filtering.png)
...
![Single column sorting](../images/adaptors/url-adaptor-sorting.png)

**Multi column sorting**
![Multi column sorting](../images/adaptors/url-adaptor-multi-sorting.png)
...
![UrlAdaptor paging](../images/adaptors/url-adaptor-paging.png)
...
![Insert record](../images/adaptors/url-adaptor-insert-record.png)
...
![Update record](../images/adaptors/url-adaptor-update-record.png)
...
![Delete Record](../images/adaptors/url-adaptor-delete-record.png)
...
![UrlAdaptor CRUD operations](../images/adaptors/adaptor-crud-operation.gif)
...
![UrlAdaptor Batch Editing](../images/adaptors/url-adaptor-batch-editing.gif)