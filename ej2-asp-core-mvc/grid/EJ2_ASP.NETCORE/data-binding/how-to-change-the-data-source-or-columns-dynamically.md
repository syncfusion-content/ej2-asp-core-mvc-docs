...
The following code demonstrates how to create the [columns](https://ej2.syncfusion.com/aspnetcore/documentation/grid/columns/columns) for the grid, which are based on the provided grid data source.
...
>* In this document, the above sample uses the local data for `changeDataSource` method. For those using a remote data source, refer to the [FlexibleData](https://ej2.syncfusion.com/aspnetcore/Grid/FlexibleData#/material) resource.