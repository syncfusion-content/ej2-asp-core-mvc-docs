...
**Step 10:** Run the project in Visual Studio.
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid/data-binding/databinding-fetch/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Local.cs" %}
{% include code-snippet/grid/data-binding/databinding-fetch/local.cs %}
{% endhighlight %}
{% endtabs %}
