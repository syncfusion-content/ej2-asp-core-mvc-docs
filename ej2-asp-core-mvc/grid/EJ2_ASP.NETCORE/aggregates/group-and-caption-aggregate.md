...
Group footer and caption aggregates in the ASP.NET Core Grid component allow you to calculate aggregate values based on the current group items. These aggregate values can be displayed in the group footer cells and group caption cells, respectively. To achieve this, you can use the `groupFooterTemplate` and `groupCaptionTemplate` properties of the `aggregateColumn`.
...
Here's an example that demonstrates how to use group footer aggregates in the ASP.NET Core Grid component:
...
Here's an example that demonstrates how to use group and caption aggregates in the ASP.NET Core Grid component:
