...
# Hierarchy Grid in ASP.NET MVC Data Grid
...
> * Hierarchical binding is not supported when [Detail Template](https://help.syncfusion.com/grid-sdk/asp-net-mvc/data-grid/row/detail-template) is enabled.
