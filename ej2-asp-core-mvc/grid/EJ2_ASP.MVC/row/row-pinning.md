...
{% include code-snippet/grid/row/row-pinning-cs1/razor %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid/row/row-pinning-cs2/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid/row/row-pinning-cs3/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid/row/row-pinning-cs4/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid/row/row-pinning-cs5/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid/row/row-pinning-cs6/razor %}
{% endhighlight %}
{% highlight c# tabtitle="row-pinning.cs" %}
