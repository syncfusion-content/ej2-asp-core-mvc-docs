...
[Sorting data in the Syncfusion<sup style="font-size:70%">&reg;</sup> Grid](https://help.syncfusion.com/grid-sdk/asp-net-mvc/data-grid/sorting)
[Filtering data in the Syncfusion<sup style="font-size:70%">&reg;</sup> Grid](https://help.syncfusion.com/grid-sdk/asp-net-mvc/data-grid/filtering/filtering)