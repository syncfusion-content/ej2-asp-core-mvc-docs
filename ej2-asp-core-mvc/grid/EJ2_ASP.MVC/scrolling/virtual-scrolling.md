...
# Virtual Scrolling in ASP.NET MVC Data Grid
...
Seamless scrolling is enabled by setting `args.enableSeamlessScrolling` to `true` inside the [Load](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Grids.Grid.html#Syncfusion_EJ2_Grids_Grid_Load) event of the Grid. This instructs the virtual scroll module to synchronize DOM updates accurately with scroll movements, preventing any white space from appearing during rapid scroll operations.

{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid/scrolling/seamless-scroll/razor %}
{% endhighlight %}
