...
Data binding is a fundamental technique that empowers the Syncfusion ASP.NET MVC Grid to integrate data into its interface, enabling the creation of dynamic and interactive Syncfusion ASP.NET MVC Grid views. This feature is particularly valuable when working with large datasets or when data needs to be fetched remotely. 
...
The Syncfusion ASP.NET MVC Grid offers a loading animation feature, which makes it easy to identify when data is being loaded or refreshed. This feature provides a clear understanding of the Syncfusion ASP.NET MVC Grid current state and actions, such as sorting, filtering, grouping, and more.
...
Refreshing the data source in a Syncfusion ASP.NET MVC Grid involves updating the data that the Syncfusion ASP.NET MVC Grid displays dynamically. This operation is essential when you need to reflect changes in the underlying data without reloading the entire page or component.
...
The Syncfusion ASP.NET MVC Grid allows dynamic modification of the data source, columns, or both . This feature is particularly valuable when you need to refresh the Syncfusion ASP.NET MVC Grid content and structure without requiring a complete page reload.
...
The following code demonstrates how to create the [Columns](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Grids.Grid.html#Syncfusion_EJ2_Grids_Grid_Columns) for the Syncfusion ASP.NET MVC Grid, which are based on the provided Syncfusion ASP.NET MVC Grid data source.
...
To bind a DataTable to the Syncfusion Syncfusion ASP.NET MVC Grid, utilize the [dataSource](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Grids.Grid.html#Syncfusion_EJ2_Grids_Grid_DataSource) property. When you bind a DataTable, Syncfusion ASP.NET MVC Grid actions such as Sorting, Filtering, Grouping, and Paging are processed on the client side, enhancing performance and responsiveness.
...
The [On-Demand Grid Actions](#handling-on-demand-grid-actions/) feature in Syncfusion Syncfusion ASP.NET MVC Grid enables server-side processing of Syncfusion ASP.NET MVC Grid actions, such as sorting, filtering, grouping, and paging. This is especially useful for applications with large datasets, where client-side operations can impact performance.

To implement on-demand server-side actions with a DataTable, you need to:

1. Convert the `DataTable` to an **IEnumerable** object.

2. Use the **DataOperations** class in the controller to process Syncfusion ASP.NET MVC Grid actions like sorting, filtering, and paging.
...
In ASP.NET MVC, by default the JSON results are returned in camelCase format. So Syncfusion ASP.NET MVC Grid field names are also changed in camelCase.
