...
The Syncfusion Grid component allows you to specify the type of data that a column binds using the [columns.type] property. The `type` property is used to determine the appropriate [format], such as [number](https://ej2.syncfusion.com/aspnetmvc/documentation/common/internationalization#number-formatting) or [date](https://ej2.syncfusion.com/aspnetmvc/documentation/common/internationalization#manipulating-datetime), for displaying the column data. 
...
{% include code-snippet/grid/columns/columntype/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ColumnType.cs" %}
{% include code-snippet/grid/columns/columntype/columntype.cs %}
{% endhighlight %}
{% endtabs %}
...
```html
  col.Field("OrderID").HeaderText("Order ID").Width("25%").TextAlign(Syncfusion.EJ2.Grids.TextAlign.Right).Add()
```
...
![Column Width](../../images/columns/column-width.png)
...
![Number Format](../../images/columns/number-format.png)
...
{% include code-snippet/grid/columns/dateformat/dateformat.cs %}
{% endhighlight %}
{% endtabs %}

![Date Format](../../images/columns/date-format.png)
