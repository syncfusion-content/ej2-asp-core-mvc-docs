---
layout: post
title: Getting Started with ##Platform_Name## DropDownButton Control | Syncfusion
...
Now, add the Syncfusion ASP.NET MVC DropDownButton control in `~/Views/Home/Index.cshtml` page.
