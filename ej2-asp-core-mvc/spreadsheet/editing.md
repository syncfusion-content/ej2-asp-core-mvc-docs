...
{% include code-snippet/spreadsheet/editing/EJ2_ASP.NETCORE/editingController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="EditingController.cs" %}
{% include code-snippet/spreadsheet/editing/EJ2_ASP.MVC/editingController.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
