...
{% include code-snippet/spreadsheet/add-context-menu/EJ2_ASP.NETCORE/addContextMenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="AddContextMenu.cs" %}
{% include code-snippet/spreadsheet/add-context-menu/EJ2_ASP.MVC/addContextMenu.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% include code-snippet/spreadsheet/remove-context-menu/EJ2_ASP.NETCORE/removeContextMenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="RemoveContextMenu.cs" %}
{% include code-snippet/spreadsheet/remove-context-menu/EJ2_ASP.MVC/removeContextMenu.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% include code-snippet/spreadsheet/enable-context-menu/EJ2_ASP.NETCORE/enableContextMenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="EnableContextMenu.cs" %}
{% include code-snippet/spreadsheet/enable-context-menu/EJ2_ASP.MVC/enableContextMenu.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
