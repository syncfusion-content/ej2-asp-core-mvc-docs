...
{% include code-snippet/spreadsheet/sort-by-cell/EJ2_ASP.NETCORE/sortController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="SortController.cs" %}
{% include code-snippet/spreadsheet/sort-by-cell/EJ2_ASP.MVC/sortController.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% include code-snippet/spreadsheet/passing-sort/EJ2_ASP.NETCORE/passingSortController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="PassingSortController.cs" %}
{% include code-snippet/spreadsheet/passing-sort/EJ2_ASP.MVC/passingSortController.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% include code-snippet/spreadsheet/custom-sort/EJ2_ASP.NETCORE/customSortController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="CustomSortController.cs" %}
{% include code-snippet/spreadsheet/custom-sort/EJ2_ASP.MVC/customSortController.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
