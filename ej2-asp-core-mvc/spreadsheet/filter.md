...
description: Learn here all about Filter of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="spreadsheet/filter", sourceFiles="filterController.cs" %}
