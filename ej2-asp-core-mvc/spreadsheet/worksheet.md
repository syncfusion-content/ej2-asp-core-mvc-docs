...
description: Learn here all about Worksheet of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="spreadsheet/insert-sheet", sourceFiles="insertSheetController.cs" %}
...
{% aspTab template="spreadsheet/header-gridlines", sourceFiles="headerController.cs" %}
...
{% aspTab template="spreadsheet/sheet-visiblity", sourceFiles="sheetVisiblityController.cs" %}
