...
{% include code-snippet/spreadsheet/scrolling/EJ2_ASP.NETCORE/scrollingController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="ScrollingController.cs" %}
{% include code-snippet/spreadsheet/scrolling/EJ2_ASP.MVC/scrollingController.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
