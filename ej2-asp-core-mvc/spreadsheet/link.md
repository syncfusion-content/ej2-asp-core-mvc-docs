...
description: Learn here all about Link of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="spreadsheet/link", sourceFiles="hyperlinkController.cs" %}
