...
N> You can also explore our [ASP.NET Core Acccordion example](https://ej2.syncfusion.com/aspnetcore/Accordion/DefaultFunctionalities#/bootstrap5) that shows you how to render and configure the Accordion in ASP.NET Core.
