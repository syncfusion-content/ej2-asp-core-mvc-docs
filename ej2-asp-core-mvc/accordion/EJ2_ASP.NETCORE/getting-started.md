...
N> You can also explore our [ASP.NET Core Acccordion example](https://ej2.syncfusion.com/aspnetcore/ContextMenu/DefaultFunctionalities#/material) that shows you how to render and configure the Accordion in ASp.NET Core.
