...
# Getting Started with ASP.NET Core RadioButton Control

This section briefly explains about how to include [ASP.NET Core RadioButton](https://www.syncfusion.com/aspnet-core-ui-controls/radio-button) control in your ASP.NET Core application using Visual Studio.
...
## Add ASP.NET Core RadioButton control

Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core RadioButton tag helper in `~/Pages/Index.cshtml` page.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core RadioButton control will be rendered in the default web browser.
