...
This section briefly explains how to include the [ASP.NET Core RadioButton](https://www.syncfusion.com/aspnet-core-ui-controls/radio-button) control in an ASP.NET Core application using Visual Studio.
