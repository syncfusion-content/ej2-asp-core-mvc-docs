---
layout: post
title: Getting Started with ASP.NET MVC Radio Button | Syncfusion
description: Learn how to get started with ASP.NET MVC Radio Button, including package installation, project configuration, and state management.
...
# Getting Started with ASP.NET MVC Radio Button
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC Radio Button control in `~/Views/Home/Index.cshtml` page.
...
The Radio Button [Checked](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Buttons.RadioButton.html#Syncfusion_EJ2_Buttons_RadioButton_Checked) property is used to handle the checked and unchecked state. In the checked state an inner circle will be added to the visualization of Radio Button.
