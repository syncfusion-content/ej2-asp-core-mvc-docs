...
![ASP.NET Core Speed Dial Control](images/speeddial-component.png)
...
![ASP.NET Core Speed Dial Control](images/speeddial-position-sample.png)
...
![ASP.NET Core Speed Dial Control](images/speeddial-mode-linear-sample.png)

![ASP.NET Core Speed Dial Control](images/speeddial-mode-radial-sample.png)
...
![ASP.NET Core Speed Dial Control](images/speeddial-event-sample.png)
