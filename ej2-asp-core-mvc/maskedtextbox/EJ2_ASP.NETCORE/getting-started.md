...
> [View Sample in GitHub](https://github.com/SyncfusionExamples/ASP-NET-Core-Getting-Started-Examples/tree/main/MaskedTextBox/ASP.NET%20Core%20Tag%20Helper%20Examples).
...
N> You can also explore our [ASP.NET Core Input Mask Example](https://ej2.syncfusion.com/aspnetcore/MaskedTextBox/DefaultFunctionalities#/material) that shows you how to render and configure the input mask.