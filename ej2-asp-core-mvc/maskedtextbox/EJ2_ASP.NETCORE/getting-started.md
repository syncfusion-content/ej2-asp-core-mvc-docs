---
layout: post
title: Getting Started with ASP.NET Core MaskedTextBox | Syncfusion
description: Learn how to get started with the Syncfusion ASP.NET Core MaskedTextBox control. Explore setup, features, examples, and customization options.
platform: ej2-asp-core-mvc
control: Masked Textbox
publishingplatform: ##Platform_Name##
documentation: ug
---

# Getting Started with ASP.NET Core MaskedTextBox

This section briefly explains how to include the [ASP.NET Core Masked Textbox](https://www.syncfusion.com/aspnet-core-ui-controls/input-mask) control in your ASP.NET Core application using Visual Studio.
...
## Add ASP.NET Core Masked Textbox control

Add the [ASP.NET Core Masked Textbox](https://www.syncfusion.com/aspnet-core-ui-controls/input-mask) control in the **~/Pages/Index.cshtml** file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [ASP.NET Core Masked Textbox](https://www.syncfusion.com/aspnet-core-ui-controls/input-mask) control will render in your default web browser.

![ASP.NET Core Masked Textbox Control](images/maskedtextbox-control.webp)
...
![ASP.NET Core Masked Textbox with Mask Element](./images/mask.webp)
...
5. [How to set cursor position while focus on the input textbox](./how-to/set-cursor-position-while-focus-on-the-input-textbox)
6. [How to display numeric keypad when focus on mobile devices](./how-to/display-numeric-keypad-when-focus-on-mobile-devices)