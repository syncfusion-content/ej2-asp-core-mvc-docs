...
This section briefly explains how to include the [ASP.NET Core RangeSlider](https://www.syncfusion.com/aspnet-core-ui-controls/range-slider) control in an ASP.NET Core application using Visual Studio.
