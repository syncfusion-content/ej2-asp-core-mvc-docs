...
description: Explore value formatting in Syncfusion ##Platform_Name## Range Slider using format API, ticks, and tooltip customization
...
* Use the [format](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Inputs.SliderTooltipData.html#Syncfusion_EJ2_Inputs_SliderTooltipData_Format) API of slider which utilizes our [Internationalization](https://ej2.syncfusion.com/aspnetcore/documentation/common/internationalization#loading-culture-data) to format values.
