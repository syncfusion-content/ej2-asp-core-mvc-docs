---
layout: post
title: Customize Slider Thumb in ##Platform_Name## Range Slider | Syncfusion
description: Learn how to customize the Range Slider thumb using CSS styles, including custom shapes, colors, and background images.
