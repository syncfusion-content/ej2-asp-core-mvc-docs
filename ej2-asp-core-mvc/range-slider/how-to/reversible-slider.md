---
layout: post
title: Reversible Range Slider in ##Platform_Name## | Syncfusion
description: Learn how to create a reversible ##Platform_Name## Range Slider by reversing the minimum and maximum values or enabling RTL mode.
