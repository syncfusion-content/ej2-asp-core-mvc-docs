---
layout: post
title: Getting Started with ##Platform_Name## TreeView Control
...
This section briefly explains about how to include [ASP.NET Core TreeView](https://www.syncfusion.com/aspnet-core-ui-controls/treeview) control in your ASP.NET Core application using Visual Studio.
...
* [Create a Project using Microsoft Templates](https://learn.microsoft.com/en-us/aspnet/core/tutorials/razor-pages/razor-pages-start?view=aspnetcore-8.0&tabs=visual-studio)
...
## Add ASP.NET Core TreeView control

Now, add the Syncfusion ASP.NET Core TreeView tag helper in `~/Pages/Index.cshtml` page.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion ASP.NET Core TreeView control will be rendered in the default web browser.

![ASP.NET Core TreeView Control.](images/binding-self.PNG)
