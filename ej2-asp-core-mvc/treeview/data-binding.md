...
description: Bind the Syncfusion ##Platform_Name## TreeView to local hierarchical or self-referential data, and remote sources via DataManager with on-demand lazy loading.
