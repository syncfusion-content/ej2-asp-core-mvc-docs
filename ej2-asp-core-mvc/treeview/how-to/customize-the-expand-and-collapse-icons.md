---
layout: post
title: Customize Expand and Collapse Icons in ##Platform_Name## | Syncfusion
...
# Customize Expand and Collapse Icons in ##Platform_Name##

You can customize the TreeView expand and collapse icons by using the [cssClass](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Navigations.TreeView.html#Syncfusion_EJ2_Navigations_TreeView_CssClass) property of TreeView. Refer to the following sample to see how to customize expand/collapse icons.
