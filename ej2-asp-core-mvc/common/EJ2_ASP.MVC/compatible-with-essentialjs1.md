---
layout: post
title: Compatible with Essential JS 1 in ##Platform_Name## Components | Syncfusion
...
Getting started for [`EJ2 ASPMVC control`](https://help.syncfusion.com/grid-sdk/asp-net-mvc/data-grid/getting-started-mvc)
