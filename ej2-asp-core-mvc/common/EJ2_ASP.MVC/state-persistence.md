...
The following table demonstrates the list of Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC controls that are supported with state persistence and describes the list of properties stored in the `localStorage`.
...
<tr>
<td><a href="https://ej2.syncfusion.com/aspnetmvc/documentation/grid/state-management">Grid</a></td>
<td>
<ul>
<li>Columns</li>
...
<tr>
<td><a href="https://help.syncfusion.com/scheduler-sdk/asp-net-mvc/schedule/state-persistence">Schedule</a></td>
<td>
<ul>
<li>currentView</li>
<li>selectedDate</li>
...
<tr>
<td><a href="https://help.syncfusion.com/gantt-sdk/asp-net-mvc/kanban/persistence">Kanban</a></td>
<td>
<ul>
<li>columns</li>
<li>dataSource</li>
