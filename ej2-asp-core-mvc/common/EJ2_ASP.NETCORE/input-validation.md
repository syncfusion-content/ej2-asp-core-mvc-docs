...
The ASP.NET Core UI input and editor controls can be validated by using [FormValidator](https://ej2.syncfusion.com/javascript/documentation/api/form-validator/) in client side.

## How to Validate ASP.NET Core UI Controls

1.Add the `Form` component in the **Index.cshtml** page. Also, declare the ASP.NET Core [TextBox](../textbox/getting-started) control inside the `Form` component.
...
The following section provides the details about the ASP.NET Core UI controls that are supported with form validation.
