...
<tbody>
    ...
    <tr>
        ...
        <td>AA</td>
        <td>Yes</td>
        <td><a target="_self" href="https://help.syncfusion.com/rich-text-editor-sdk/asp-net-core/rich-text-editor/accessibility">Documentation</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>AA</td>
        <td>Yes</td>
        <td><a target="_self" href="https://help.syncfusion.com/diagram-sdk/asp-net-core/accessibility">Documentation</a></td>
    </tr>
    <tr>
        <td>HeatMap Chart</td>
        <td>Yes</td>
    ...
    <tr>
        ...
        <td>AA</td>
        <td>Yes</td>
        <td><a target="_self" href="https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/accessiblility">Documentation</a></td>
    </tr>
    <tr>
        <td>Button</td>
        <td>Yes</td>
    ...
    <tr>
        ...
        <td>AA</td>
        <td>Yes</td>
        <td><a target="_self" href="https://help.syncfusion.com/gantt-sdk/asp-net-core/gantt-chart/accessibility">Documentation</a></td>
    </tr>
    <tr>
        <td>Schedule</td>
        <td>Yes</td>
        <td>AA</td>
        <td>Yes</td>
        <td><a target="_self" href="https://help.syncfusion.com/scheduler-sdk/asp-net-core/schedule/accessibility">Documentation</a></td>
    </tr>
    <tr>
        <td>SpeechToText</td>
        <td>Yes</td>
