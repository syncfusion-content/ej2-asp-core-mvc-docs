...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> Grid control to an application

In previous steps, the ASP.NET Core package is successfully configured in the application. Now, add the grid control to your **Index.cshtml** view page which is present under `Views/Home` folder.
...
## Handling CRUD operations with Syncfusion<sup style="font-size:70%">&reg;</sup> Grid control
...
N> [View sample in GitHub](https://github.com/SyncfusionExamples/asp-net-core-data-binding/tree/main/WebAPI%20Service%20Binding)
