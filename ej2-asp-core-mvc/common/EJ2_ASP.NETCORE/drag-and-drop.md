...
# Drag and Drop support in ASP.NET Core controls

* Drag and Drop support can be enabled for ASP.NET Core controls by setting `allowDragAndDrop` property to `true`. It allows to drag and drop the specific elements in the ASP.NET Core controls.
...
The following list demonstrates the ASP.NET Core control documents that are supported with Drag and Drop.
