...
description: Checkout and learn about Integration of Azure OpenAI in Syncfusion ##Platform_Name## Inline AI Assist control of Syncfusion Essential JS 2 and more.
...
# Integrate Azure OpenAI with ASP.NET Core Inline AI Assist control
...
* **Syncfusion Inline AI Assist**: Package [Syncfusion.EJ2.AspNet.Core](https://www.nuget.org/packages/Syncfusion.EJ2.AspNet.Core) installed.
...
Modify the `index.cshtml` file to integrate the Azure OpenAI with the Inline AI Assist control.
...
{% include code-snippet/inline-ai-assist/ai-integrations/open-ai/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Gemini.cs" %}
{% include code-snippet/inline-ai-assist/ai-integrations/open-ai/openaicore.cs %}
{% endhighlight %}
{% endtabs %}
