...
## Configure Inline AI Assist with Ollama in ASP.NET Core
...
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="llm-model.cs" %}
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/llm-model-core.cs %}
{% endhighlight %}
{% endtabs %}
