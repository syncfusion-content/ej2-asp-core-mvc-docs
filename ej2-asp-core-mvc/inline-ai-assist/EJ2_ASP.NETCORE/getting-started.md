---
layout: post
title: Getting Started with ##Platform_Name## InlineAIAssist Control | Syncfusion
...
This section briefly explains about how to include `ASP.NET Core Inline AI Assist` control in your ASP.NET Core application using Visual Studio.
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Inline AI Assist tag helper in `~/Pages/Index.cshtml` page.

Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Inline AI Assist control will be rendered in the default web browser.
