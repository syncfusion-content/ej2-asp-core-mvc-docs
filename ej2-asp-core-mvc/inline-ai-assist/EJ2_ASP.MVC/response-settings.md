...
You can render response action popup by using `Items` property in the [responseSettings](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.InteractiveChat.InlineAIAssistResponseSettings.html) property. This feature enables users to accept, discard, or perform custom actions on AI-generated responses.
...
You can use the [ResponseSettings](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.InteractiveChat.InlineAIAssistResponseSettings.html) property to add custom items for the response popup in Inline AI Assist. The custom items will be displayed together with the existing built-in items in the response popup.
