...
## Add ASP.NET MVC Inline AI Assist control

Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC Inline AI Assist control in `~/Views/Home/Index.cshtml` page.
