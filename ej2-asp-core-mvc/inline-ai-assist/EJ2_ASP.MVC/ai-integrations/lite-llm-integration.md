...
* The [promptRequest](https://ej2.syncfusion.com/aspnetmvc/documentation/api/inline-ai-assist/inlineaiassistmodel#promptrequest) event sends the user prompt to the LiteLLM proxy at `http://localhost:4000/v1/chat/completions`. 
