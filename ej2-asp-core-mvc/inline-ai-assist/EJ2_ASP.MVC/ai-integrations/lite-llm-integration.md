...
* **Syncfusion Inline AI Assist**: Install the package [Syncfusion.EJ2.MVC5](https://www.nuget.org/packages/Syncfusion.EJ2.MVC5).
...
To integrate **LiteLLM** with the **Syncfusion Inline AI Assist** control, update the `index.cshtml` file in your ASP.NET MVC application. The control will send user prompts to the LiteLLM proxy, which forwards them to the configured LLM provider (e.g., **OpenAI** or **Azure OpenAI**) and returns natural language responses.
...
{% include code-snippet/inline-ai-assist/ai-integrations/lite-llm/razor %}
{% endhighlight %}
{% highlight c# tabtitle="LiteLLM.cs" %}
{% include code-snippet/inline-ai-assist/ai-integrations/lite-llm/litellmmvc.cs %}
{% endhighlight %}
