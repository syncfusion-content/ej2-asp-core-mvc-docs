...
description: Checkout and learn about Integration of Gemini AI in Syncfusion ##Platform_Name## Inline AI Assist control of Syncfusion Essential JS 2 and more.
...
# Integrate Gemini AI with ASP.NET MVC Inline AI Assist control
...
Modify the `index.cshtml` file to integrate the Gemini AI with the Inline AI Assist control.
...
{% include code-snippet/inline-ai-assist/ai-integrations/gemini-ai/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Gemini.cs" %}
{% include code-snippet/inline-ai-assist/ai-integrations/gemini-ai/geminimvc.cs %}
{% endhighlight %}
{% endtabs %}
