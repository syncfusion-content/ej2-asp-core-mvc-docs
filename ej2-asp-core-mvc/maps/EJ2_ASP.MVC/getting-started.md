...
N> The `shapeData` in the `ViewBag` object is already assigned to the Maps component and refer the map data values for the [world-map](https://www.syncfusion.com/downloads/support/directtrac/general/ze/WorldMap-637657487) here.
