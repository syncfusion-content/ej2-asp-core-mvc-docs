...
To load translation object in the application, use `load` function of **L10n** class. For more information about localization, refer [here](https://ej2.syncfusion.com/documentation/api/base/l10n).
