...
ASP.NET Core controls support touch (bigger theme) and normal size modes. The following topics explains how to enable the same in your application.
...
Refer below topics to learn about responsiveness controls based on the available size in ASP.NET Core Controls.
