...
The Package Manager Console saves NuGet packages installation time since you don’t have to search for the Syncfusion ASP.NET Core NuGet package which you want to install, and you can just type the installation command to install the appropriate Syncfusion ASP.NET Core NuGet package. Follow the instructions below to use the Package Manager Console to reference the Syncfusion ASP.NET Core control as NuGet packages in your ASP.NET Core application.
