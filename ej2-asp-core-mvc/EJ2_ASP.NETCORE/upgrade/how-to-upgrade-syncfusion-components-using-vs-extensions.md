---
layout: post
title:Upgrading Syncfusion ASP .NET Core EJ2 components to a latest version
description: Learn here about the how upgrade Syncfusion ASP .NET Core EJ2 components to a latest version from NuGet manager and migrate.
