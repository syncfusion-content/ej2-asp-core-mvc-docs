...
2. Get a new license from the [Syncfusion sales page](https://www.syncfusion.com/sales/pricing).
...
1. Get a new license from the [Syncfusion sales page](https://www.syncfusion.com/sales/pricing).
