...
<button id="PreviewSampleButton1" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/item-template-cs1/index.html',this.id);">Run Preview Sample</button>
...
<button id="PreviewSampleButton2" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/item-template-cs2/index.html',this.id);">Run Preview Sample</button>
...
<button id="PreviewSampleButton3" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/item-template-cs3/index.html',this.id);">Run Preview Sample</button>
...
<button id="PreviewSampleButton4" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/header-template-cs1/index.html',this.id);">Run Preview Sample</button>
...
<button id="PreviewSampleButton5" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/footer-template-cs1/index.html',this.id);">Run Preview Sample</button>
...
<button id="PreviewSampleButton6" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/norecords-template-cs1/index.html',this.id);">Run Preview Sample</button>
...
<button id="PreviewSampleButton7" onclick="LoadPreviewSample('https://ej2.syncfusion.com/documentation/samples/dropdownlist/norecords-template-cs2/index.html',this.id);">Run Preview Sample</button>
