...
3. [Upgrade project](upgrade-project): Upgrades the existing Syncfusion ASP.NET Core (Essential JS 2) application from one Essential Studio&reg; version to another version.
