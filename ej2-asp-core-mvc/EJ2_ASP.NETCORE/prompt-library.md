...
description: Explore the AI Coding Assistants Tools Prompt Library to boost ASP.NET Core productivity with code generation, configuration examples, and contextual guidance.
...
* Run the prompt using either of the following AI tools:
  ...
  * **Skills**: Skills can also run automatically based on the query, or can be called explicitly using the `/syncfusion-aspnetcore-grid` skill.
