---
layout: post
title: Getting Started with ASP.NET Core Calendar Component | Syncfusion
...
This section briefly explains about how to include [ASP.NET Core Calendar](https://www.syncfusion.com/aspnet-core-ui-controls/calendar) control in your ASP.NET Core application using Visual Studio.
...
N> You can also explore our [ASP.NET Core Calendar Example](https://ej2.syncfusion.com/aspnetcore/Calendar/DefaultFunctionalities#/bootstrap5) that shows you how to render the Calendar in ASP.NET Core.