...
description: Check out and learn about getting started with Syncfusion Essential ##Platform_Name## SpeechToText control, its elements, and more details.
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core SpeechToText tag helper in the `~/Pages/Index.cshtml` page.
