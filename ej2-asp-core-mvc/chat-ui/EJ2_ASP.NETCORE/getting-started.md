...
description: Check out and learn about getting started with ##Platform_Name## Chat UI control of Syncfusion Essential JS 2 and more details.
...
Now, add the Syncfusion ASP.NET Core Chat UI tag helper in the `~/Pages/Index.cshtml` page.
