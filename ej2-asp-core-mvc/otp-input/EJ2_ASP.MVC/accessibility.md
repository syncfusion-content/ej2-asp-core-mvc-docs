...
description: Learn about accessibility support in ##Platform_Name## OTP Input, including WCAG 2.2 compliance, ARIA attributes, keyboard navigation, and screen reader support.
