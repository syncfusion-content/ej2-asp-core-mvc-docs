...
## Add ASP.NET MVC OTP Input control

Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC OTP Input control in `~/Home/Index.cshtml` page.

{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/otp-input/getting-started/default/razor %}
{% endhighlight %}
{% endtabs %}
