...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Breadcrumb tag helper in `~/Pages/Index.cshtml` page.
...
Use the `items` property to bind the items to the Breadcrumb control.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Breadcrumb control will be rendered in the default web browser.

![ASP.NET Core Breadcrumb Control](./images/items.png)
...
N> You can also explore our [ASP.NET Core Breadcrumb example](https://ej2.syncfusion.com/aspnetcore/breadcrumb/defaultfunctionalities#/fluent2) that shows you how to render and configure the Breadcrumb.