...
description: Override the ASP.NET MVC Carousel CSS classes to restyle slides, indicators, navigators, and the partial-slide container for custom themes.
...
# Styles and Appearances in ASP.NET MVC Carousel Component
...
## CSS Structure in ASP.NET MVC Carousel Component
