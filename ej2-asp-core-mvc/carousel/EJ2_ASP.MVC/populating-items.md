...
The last slide will be displayed as a partial slide at the initial rendering when the [`loop`](https://help.syncfusion.com/cr/aspnetmvc-js2/syncfusion.ej2.navigations.carousel.html#Syncfusion_EJ2_Navigations_Carousel_Loop) and `partialVisible` properties are enabled.
