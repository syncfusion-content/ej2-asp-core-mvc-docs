...
N> You can also explore our [ASP.NET Core Carousel example](https://ej2.syncfusion.com/aspnetcore/carousel/defaultfunctionalities#/fluent2) that shows you how to render and configure the Carousel.