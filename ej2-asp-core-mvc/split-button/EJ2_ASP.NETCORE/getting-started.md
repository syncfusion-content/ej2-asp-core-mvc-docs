...
<head>
    ...
    <!-- Syncfusion ASP.NET Core Split Button control script -->
...
## Add ASP.NET Core Split Button control

Add the [ASP.NET Core Split Button](https://www.syncfusion.com/aspnet-core-ui-controls/split-button) control in the **~/Pages/Index.cshtml** file.
