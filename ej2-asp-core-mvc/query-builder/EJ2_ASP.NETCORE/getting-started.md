---
layout: post
title: Getting Started with ASP.NET Core Query Builder | Syncfusion
description: Learn how to get started with ASP.NET Core Query Builder, including installation, package configuration, data binding, and rule creation.
...
dotnet add package Syncfusion.AspNetCore.QueryBuilder -v {{ site.releaseversion }}
