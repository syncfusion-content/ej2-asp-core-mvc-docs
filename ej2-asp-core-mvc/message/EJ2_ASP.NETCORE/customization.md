...
description: Customize Syncfusion ##Platform_Name## Message content alignment, corner radius, and border style by setting the cssClass and using custom content templates.
