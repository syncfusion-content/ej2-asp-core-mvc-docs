...
The [ASP.NET Core Message](https://www.syncfusion.com/aspnet-core-ui-controls/message) control allows user to customize the content display positions and appearance. This section explains the details about changing the content alignments and border styles for messages.
