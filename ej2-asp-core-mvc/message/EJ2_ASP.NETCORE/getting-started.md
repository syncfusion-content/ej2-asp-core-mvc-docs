...
description: Check out and learn about getting started with ##Platform_Name## Message control of Syncfusion Essential JS 2 and more details.
...
In this getting started walk-through, the required scripts are referred using CDN inside the `<head>` of the `~/Pages/Shared/_Layout.cshtml` file as follows.
...
Now, add the Syncfusion ASP.NET Core Message tag helper in the `~/Pages/Index.cshtml` page.
