...
description: Configure Syncfusion ##Platform_Name## Message icons by hiding defaults and adding custom severity icons via the showIcon and showCloseIcon properties.
