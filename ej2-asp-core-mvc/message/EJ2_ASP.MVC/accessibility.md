...
description: Syncfusion ##Platform_Name## Message follows WAI-ARIA roles for severity messages including Note, Info, Success, Warning, Error, and Close button support.
