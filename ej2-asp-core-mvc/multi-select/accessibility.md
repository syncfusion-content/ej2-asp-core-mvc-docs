---
layout: post
title: Accessibility in ##Platform_Name## MultiSelect | Syncfusion
description: Syncfusion ##Platform_Name## MultiSelect follows WAI-ARIA roles, states, and keyboard navigation patterns for accessibility on multi-option selection.
