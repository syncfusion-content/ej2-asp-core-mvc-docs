...
{% include code-snippet/blockeditor/editor-menus/slash-command/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/blockeditor/editor-menus/context-menu/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/blockeditor/editor-menus/block-action/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/blockeditor/editor-menus/inline-toolbar/tagHelper %}
{% endhighlight %}
