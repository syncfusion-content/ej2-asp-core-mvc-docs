...
The Undo feature enables users to revert the most recent action performed in the [ASP.NET Core Gantt Chart](https://www.syncfusion.com/aspnet-core-ui-controls/gantt-chart). It helps undo changes made to tasks, dependencies, or other actions within the Gantt Chart.
