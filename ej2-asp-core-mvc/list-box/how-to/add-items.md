...
description: Add Syncfusion ##Platform_Name## ListBox items at runtime by pushing into the dataSource or using the addItem method and refresh the list view.
