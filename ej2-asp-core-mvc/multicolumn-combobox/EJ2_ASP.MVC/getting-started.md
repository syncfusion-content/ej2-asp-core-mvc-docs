---
layout: post
title: Getting Started with ASP.NET MVC MultiColumn ComboBox Control | Syncfusion
...
## Add ASP.NET MVC MultiColumn ComboBox control

Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC MultiColumn ComboBox control in `~/Views/Home/Index.cshtml` page.

{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/multicolumn-combobox/getting-started/razor %}
{% endhighlight %}
