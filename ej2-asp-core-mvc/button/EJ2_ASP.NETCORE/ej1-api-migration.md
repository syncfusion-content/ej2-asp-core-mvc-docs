...
description: Map Essential JS 1 Button properties, methods, and events to their Essential JS 2 equivalents for ASP.NET Core migration.
...
# Ej1 Api Migration in ##Platform_Name## Button
