...
![ASP.NET MVC Skeleton Control](images/skeleton-component.png)

## Shapes

The [`shape`](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Notifications.Skeleton.html#Syncfusion_EJ2_Notifications_Skeleton_Shape) property can be used to display skeleton in different shapes like circle, square, rectangle and text.
...
![ASP.NET MVC Skeleton Control](images/skeleton-shape-sample.png)