...
| **Complete event** | **Event**: *action-complete* <br/>`<ej-drop-down-list actionComplete="actionComplete"></ej-drop-down-list>` | **Event**: *actionComplete* <br/>`<ejs-dropdownlist id="customers" actionComplete="actionComplete"></ejs-dropdownlist>`|
...
| **Filter type** | **Property**: *filter-type* <br/>`<ej-drop-down-list filter-type="@SearchFilterType.StartsWith"></ej-drop-down-list>` |<https://ej2.syncfusion.com/demos/#/tailwind3/drop-down-list/filtering.html> |
...
| **Floating waterMarkText** | **Not applicable** |	**Property**: *floatLabelType* <br/>`<ejs-dropdownlist floatLabelType="Auto"/>`|
...
| Enable Persistence | **Property**: *enable-persistence*<br/>`<ej-drop-down-list enable-presistence="true"/>` |**Property**: *enablePersistence*<br/>`<ejs-dropdownlist enablePersistence="true"></ejs-dropdownlist>` |
...
| **Focus in event**| **Event**: *focusIn*<br/><br/>`<ej-drop-down-list focus-in="focus"></ej-drop-down-list>` | **Event**: *focus*<br/>`<ejs-dropdownlist focus ="onFocus" />` |
