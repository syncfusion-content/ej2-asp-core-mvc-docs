...
Now, add the `Spinner` using Syncfusion<sup style="font-size:70%">&reg;</sup> Essential<sup style="font-size:70%">&reg;</sup> JavaScript library in `~/Views/Home/Index.cshtml` page.
