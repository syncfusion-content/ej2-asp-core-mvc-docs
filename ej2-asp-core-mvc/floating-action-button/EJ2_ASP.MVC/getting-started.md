...
# Getting Started with ASP.NET MVC Fab Control

This section briefly explains about how to include [ASP.NET MVC Fab] control in your ASP.NET MVC application using Visual Studio.
...
## Add ASP.NET MVC Fab control

Now, add the Syncfusion ASP.NET MVC Fab control in `~/Views/Home/Index.cshtml` page.
...
![ASP.NET MVC Fab Control](images/default.png)
...
![ASP.NET MVC Fab Control](images/position.png)
