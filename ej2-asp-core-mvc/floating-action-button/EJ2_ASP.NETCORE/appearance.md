...
description: Learn here all about Appearance in Syncfusion ##Platform_Name## Floating Action Button control of Syncfusion Essential JS 2 and more.
...
# Appearance of ASP.NET Core Floating Action Button Control
...
{% include code-snippet/floating-action-button/appearance/fab-styles/tagHelper %}
{% endhighlight %}
{% endtabs %}

{% endif %}

![Asp.Net Core Floating Action Button Control with different built-in styles](images/Style.png)
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/floating-action-button/appearance/onhover/tagHelper %}
{% endhighlight %}
{% endtabs %}

{% endif %}

![Asp.Net Core Floating Action Button control with customizing the content](images/onhover.png)
