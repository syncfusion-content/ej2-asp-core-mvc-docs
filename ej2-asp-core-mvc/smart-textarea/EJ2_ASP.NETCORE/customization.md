...
![ASP.NET Core Smart TextArea Control Suggestion on popup](images/SmartTextArea-Popup.webp)
...
![ASP.NET Core Smart TextArea Control Suggestion on inline](images/SmartTextArea-Inline.webp)
