---
layout: post
title: Style and Appearance in ASP.NET Core Toggle Switch Button | Syncfusion
description: Customize the Syncfusion ASP.NET Core Toggle Switch Button appearance by overriding CSS classes for bar, handle, hover, and active states.
...
# Style and Appearance in ASP.NET Core Toggle Switch Button
