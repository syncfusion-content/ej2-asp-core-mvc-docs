...
> [View Sample in GitHub](https://github.com/SyncfusionExamples/ASP-NET-Core-Getting-Started-Examples/tree/main/ContextMenu/ASP.NET%20Core%20Tag%20Helper%20Examples)
...
N> You can also explore our [ASP.NET Core Context Menu example](https://ej2.syncfusion.com/aspnetcore/Contextmenu/DefaultFunctionalities#/bootstrap5) that shows you how to render and configure the Context Menu in ASP.NET Core.
