...
This section briefly explains how to include the [ASP.NET Core Toast](https://www.syncfusion.com/aspnet-core-ui-controls/toast) control in an ASP.NET Core application using Visual Studio.
