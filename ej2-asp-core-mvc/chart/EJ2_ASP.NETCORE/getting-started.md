---
layout: post
title: Getting Started with ##Platform_Name## Chart Control
...
Now, add the Syncfusion ASP.NET Core Chart tag helper in `~/Pages/Index.cshtml` page.
...
> [View Sample in GitHub](https://github.com/SyncfusionExamples/ASP-NET-Core-Getting-Started-Examples/tree/main/Chart/ASP.NET%20Core%20Tag%20Helper%20Examples).
