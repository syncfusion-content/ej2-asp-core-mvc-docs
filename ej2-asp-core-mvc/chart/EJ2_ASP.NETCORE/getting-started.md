...
This section explains how to add the Syncfusion<sup style="font-size:70%">&reg;</sup> [ASP.NET Core Chart](https://www.syncfusion.com/aspnet-core-ui-controls/charts) control to your application using Visual Studio.
...
To integrate the ASP.NET Core Chart component, install the required [Syncfusion.EJ2.AspNet.Core](https://www.nuget.org/packages/Syncfusion.EJ2.AspNet.Core/) NuGet packages using the integrated terminal:
...
Add the ASP.NET Core Chart tag helper to the `~/Pages/Index.cshtml` page.
...
The ASP.NET Core Chart control will be rendered in the default web browser.
