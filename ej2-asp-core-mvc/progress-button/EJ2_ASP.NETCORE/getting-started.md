...
N> You can also explore our [ASP.NET Core Progress Button example](https://ej2.syncfusion.com/aspnetcore/button/progressbutton#/fluent2) that shows you how to render and configure the Progress Button.