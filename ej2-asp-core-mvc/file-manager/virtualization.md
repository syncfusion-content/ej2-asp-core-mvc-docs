...
description: Learn how to enable virtualization in the ##Platform_Name## File Manager for dynamically loading large folders in Details and Large Icons views without performance loss.
