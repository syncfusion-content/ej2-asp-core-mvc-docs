...
description: Learn here all about Access Control of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="file-manager/access-control", sourceFiles="HomeController_core.cs,HomeController_mvc.cs" %}
