---
layout: post
title: EJ1 API Migration in ##Platform_Name## Linear Gauge | Syncfusion
description: Learn here all about Ej1 Api Migration in Syncfusion ##Platform_Name## Linear Gauge component of Syncfusion Essential JS 2 and more.
