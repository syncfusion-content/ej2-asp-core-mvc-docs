...
N> You can also explore our [ASP.NET Core Linear Gauge example](https://ej2.syncfusion.com/aspnetcore/LinearGauge/Default#/material) that shows you how to render the Linear Gauge in ASP.NET Core.