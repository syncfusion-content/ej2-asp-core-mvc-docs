...
description: Display the Syncfusion ASP.NET MVC DateTimePicker value in the client system local time zone and bind server values correctly via the serverTimezoneOffset property.
