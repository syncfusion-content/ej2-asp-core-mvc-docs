---
layout: post
title: Orientations in ASP.NET MVC Timeline | Syncfusion
description: Display Syncfusion ASP.NET MVC Timeline items in horizontal or vertical direction by setting the `orientation` property.
...
# Orientations in ASP.NET MVC Timeline
