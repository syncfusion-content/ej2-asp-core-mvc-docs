---
layout: post
title: Reverse in ASP.NET MVC Timeline | Syncfusion
description: Display Syncfusion ASP.NET MVC Timeline items in reverse order for different alignments using the `reverse` property for better user interaction.
...
# Reverse in ASP.NET MVC Timeline
