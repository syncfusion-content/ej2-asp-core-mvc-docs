---
layout: post
title: Events in ASP.NET MVC Timeline | Syncfusion
description: Handle the Syncfusion ASP.NET MVC Timeline `created` event to detect when the control rendering is completed.
...
# Events in ASP.NET MVC Timeline
