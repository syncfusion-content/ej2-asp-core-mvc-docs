---
layout: post
title: Template in ASP.NET Core Timeline | Syncfusion
description: Customize each Syncfusion ASP.NET Core Timeline item with the `template` property to modify dot items, templated content, and progress bar styling.
...
# Template in ASP.NET Core Timeline
