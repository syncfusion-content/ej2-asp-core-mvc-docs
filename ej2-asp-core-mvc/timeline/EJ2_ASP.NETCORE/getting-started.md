...
This section briefly explains about how to include `ASP.NET Core Timeline` control in your ASP.NET Core application using Visual Studio.
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Timeline tag helper in `~/Pages/Index.cshtml` page.
