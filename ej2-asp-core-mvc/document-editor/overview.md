...
* [Opens](./EJ2_ASP.NETCORE/import) the native `Syncfusion Document Text (*.sfdt)` format documents in the client-side.

{% elsif page.publishingplatform == "aspnet-mvc" %}

* [Opens](./EJ2_ASP.MVC/import) the native `Syncfusion Document Text (*.sfdt)` format documents in the client-side.
