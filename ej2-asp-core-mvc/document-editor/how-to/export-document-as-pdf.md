...
N> You can install the PDF export packages from this [`link`](https://www.npmjs.com/package/@syncfusion/ej2-pdf-export)and There is one limitation, the text can't be searched because the PDF is exported as image.
