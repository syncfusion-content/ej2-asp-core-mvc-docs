...
description: Migrate ##Platform_Name## Checkbox APIs from Essential JS 1 to Essential JS 2 with side-by-side maps for label, checked, indeterminate, and events.
