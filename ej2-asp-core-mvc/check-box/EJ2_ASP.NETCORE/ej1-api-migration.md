...
description: Migrate ASP.NET Core Checkbox tag helpers from Essential JS 1 to Essential JS 2 with side-by-side maps for label, checked, indeterminate, and events.
