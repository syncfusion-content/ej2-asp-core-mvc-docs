...
N> You can also explore our [ASP.NET Core RangeNavigator example](https://ej2.syncfusion.com/aspnetcore/RangeNavigator/Default#/material) that shows you how to render and configure the RangeNavigator in ASP.NET Core.
