---
layout: post
title: Getting Started with ##Platform_Name## RangeNavigator Control
description: Checkout and learn about getting started with ##Platform_Name## RangeNavigator control of Syncfusion Essential JS 2 and more details.
...
Now, add the ASP.NET Core RangeNavigator tag helper in `~/Pages/Index.cshtml` page.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the ASP.NET Core RangeNavigator control will be rendered in the default web browser.
