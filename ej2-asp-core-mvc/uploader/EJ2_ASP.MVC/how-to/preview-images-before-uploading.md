---
layout: post
title: How to preview images before uploading in ASP.NET MVC File Upload | Syncfusion
description: Preview images before uploading in the Syncfusion ASP.NET MVC File Upload by reading file data inside the selected or success event handlers.
...
# How to preview images before uploading in ASP.NET MVC File Upload
