---
layout: post
title: How to trigger the input-file click event from an external button in ASP.NET MVC File Upload | Syncfusion
...
# How to trigger the input-file click event from an external button in ASP.NET MVC File Upload
