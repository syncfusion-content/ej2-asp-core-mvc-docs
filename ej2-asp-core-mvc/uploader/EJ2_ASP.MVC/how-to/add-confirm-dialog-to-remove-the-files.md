---
layout: post
title: How to add a confirmation dialog when removing files in ASP.NET MVC File Upload | Syncfusion
...
# How to add a confirmation dialog when removing files in ASP.NET MVC File Upload
