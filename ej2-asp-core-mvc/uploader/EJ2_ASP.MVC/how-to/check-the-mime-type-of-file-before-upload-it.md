---
layout: post
title: How to check the MIME type of a file before upload in ASP.NET MVC File Upload | Syncfusion
...
# How to check the MIME type of a file before upload in ASP.NET MVC File Upload
