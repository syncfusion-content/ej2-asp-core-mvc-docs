---
layout: post
title: EJ1 API Migration in ASP.NET MVC File Upload | Syncfusion
description: Migrate your ASP.NET MVC File Upload from Essential JS 1 to Essential JS 2 with this API mapping guide listing renamed properties, events, and methods.
...
# EJ1 API Migration in ASP.NET MVC File Upload
