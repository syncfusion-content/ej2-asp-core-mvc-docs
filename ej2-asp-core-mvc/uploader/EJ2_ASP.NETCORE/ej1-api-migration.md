...
description: Migrate your ##Platform_Name## File Upload from Essential JS 1 to Essential JS 2 with this API mapping guide listing renamed properties, events, and methods.
