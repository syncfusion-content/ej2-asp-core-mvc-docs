---
layout: post
title: How to get the total size of selected files in ASP.NET Core File Upload | Syncfusion
...
# How to get the total size of selected files in ASP.NET Core File Upload
