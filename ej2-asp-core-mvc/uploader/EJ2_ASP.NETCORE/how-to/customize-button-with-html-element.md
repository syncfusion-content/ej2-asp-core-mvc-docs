---
layout: post
title: How to customize the browse button with an HTML element in ASP.NET Core File Upload | Syncfusion
...
# How to customize the browse button with an HTML element in ASP.NET Core File Upload
