---
layout: post
title: Determine Whether The Uploader Has Input File in ASP.NET Core | Syncfusion
...
# Determine whether uploader has file input (required validation) in ASP.NET Core
