---
layout: post
title: How to resize images before uploading to the server in ASP.NET Core File Upload | Syncfusion
...
# How to resize images before uploading to the server in ASP.NET Core File Upload
