---
layout: post
title: About Syncfusion ##Platform_Name## File Upload | Syncfusion
description: Discover the Syncfusion ##Platform_Name## File Upload: a control to upload images and files to the server with async, drag-drop, progress, and validation.
...
# About Syncfusion ##Platform_Name## File Upload Component.
