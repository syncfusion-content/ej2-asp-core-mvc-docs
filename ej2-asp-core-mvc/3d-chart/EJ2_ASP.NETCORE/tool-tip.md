...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/3d-chart/series/user-interaction/inline-format/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="inline-format.cs" %}
{% include code-snippet/3d-chart/series/user-interaction/inline-format/inline-format.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/3d-chart/series/user-interaction/inline-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Razor.cs" %}
{% include code-snippet/3d-chart/series/user-interaction/inline-format/razor.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
