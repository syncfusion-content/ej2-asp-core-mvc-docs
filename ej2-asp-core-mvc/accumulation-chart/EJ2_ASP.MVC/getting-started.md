...
This section briefly explains how to add the [ASP.NET MVC AccumulationChart](https://www.syncfusion.com/aspnet-mvc-ui-controls/charts) control to an ASP.NET MVC application using Visual Studio.
...
## Add the ASP.NET MVC AccumulationChart Control

Add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC AccumulationChart control to the `~/Home/Index.cshtml` page.
