...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart/accumulation-charts/tooltip/inline-format/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Inline-format.cs" %}
{% include code-snippet/chart/accumulation-charts/tooltip/inline-format/inline-format.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart/accumulation-charts/tooltip/inline-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Razor.cs" %}
{% include code-snippet/chart/accumulation-charts/tooltip/inline-format/razor.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
