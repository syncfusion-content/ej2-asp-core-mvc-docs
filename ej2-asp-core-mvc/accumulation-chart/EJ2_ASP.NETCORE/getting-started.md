...
This section explains how to add the [ASP.NET Core Accumulation Chart](https://www.syncfusion.com/aspnet-core-ui-controls/charts) control to your application using Visual Studio.
