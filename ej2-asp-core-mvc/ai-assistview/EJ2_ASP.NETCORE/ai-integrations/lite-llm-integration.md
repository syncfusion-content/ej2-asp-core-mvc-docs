...
# Integrate LiteLLM with ASP.NET Core AI AssistView control
...
The frontend sends prompts to the server (`/?handler=GetAIResponse`), which proxies the request to LiteLLM.
