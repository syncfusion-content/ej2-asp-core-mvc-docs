---
layout: post
title: EJ1 API Migration in ASP.NET MVC Tabs | Syncfusion
description: Migrate the Syncfusion ASP.NET MVC Tabs from Essential JS 1 to Essential JS 2 by mapping old API properties and events to their new equivalents.
...
# EJ1 API Migration in ASP.NET MVC Tabs
