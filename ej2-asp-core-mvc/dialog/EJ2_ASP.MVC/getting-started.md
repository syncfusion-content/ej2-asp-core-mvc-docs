...
description: Get started with the Syncfusion ##Platform_Name## Dialog control in an MVC application using Visual Studio with Html helper and TagHelper support.
