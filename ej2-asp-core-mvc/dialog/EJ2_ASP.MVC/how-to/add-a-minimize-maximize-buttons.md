---
layout: post
title: How to add min and max buttons to Dialog header in ASP.NET MVC Dialog | Syncfusion
...
# How to add min and max buttons to Dialog header in ASP.NET MVC Dialog
