---
layout: post
title: How to close Dialog on outside click in ASP.NET MVC Dialog | Syncfusion
description: Close the Syncfusion ASP.NET MVC Dialog when the user clicks outside its region by calling the hide method on the outside click event.
...
# How to close Dialog on outside click in ASP.NET MVC Dialog
