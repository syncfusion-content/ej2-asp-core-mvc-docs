...
# How to show Dialog in fullscreen in ##Platform_Name##

You can display the Dialog in fullscreen by passing `true` as an argument to the Dialog's `show` method. This will expand the Dialog to occupy the entire screen.
