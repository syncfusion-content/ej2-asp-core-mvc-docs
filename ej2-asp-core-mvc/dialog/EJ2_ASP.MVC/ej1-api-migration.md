---
layout: post
title: EJ1 API Migration in ASP.NET MVC Dialog | Syncfusion
description: Migrate the Dialog control from Essential JS 1 to Essential JS 2 with property-by-property API mapping for ASP.NET MVC applications.
