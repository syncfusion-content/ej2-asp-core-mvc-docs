...
description: Syncfusion ##Platform_Name## Dialog is a window that displays information and gathers user input as a modal or modeless overlay with rich templates.
