...
description: Migrate the Dialog control from Essential JS 1 to Essential JS 2 with property-by-property API mapping for ##Platform_Name## applications.
...
| ---------- | ----------------------- | ----------------------- |
| Keyboard Navigation | **Property** : allowKeyboardNavigation<br/> <br/>`<ej-dialog id="dialog" allow-keyboard-navigation="true"></ej-dialog>` | No separate property to enable/disable keyboard navigation. It's enabled by default. |
...
| Event triggered when click on action buttons | **Event:** actionButtonClick<br/><br/> `<ej-dialog id="dialog" action-button-click="playMedia"></ej-dialog>`<br/><br/>`function playMedia(args) {}`<br/> | Not Applicable |
...
| Event triggered when expanding the collapsed dialog | **Event:** expand<br/> <br/>`<ej-dialog id="dialog" expand="expandAction"></ej-dialog>`<br/><br/>`function expandAction(args) {}`<br/> | Not Applicable |
| Event triggered when collapsing the expanded dialog | **Event:** collapse<br/> <br/>`<ej-dialog id="dialog" collapse="collapseAction"></ej-dialog>`<br/><br/>`function collapseAction(args) {}`<br/> | Not Applicable |
...
| Footer action buttons | Not Applicable | **Property** : buttons<br/> <br/>`@{ var defaultbutton = new ButtonModel() { content = "OK" }; }`<br/><br/>`<ejs-dialog id="dialog"><e-dialog-buttons><e-dialog-dialogbutton buttonModel="defaultbutton" click="dlgButtonClick"></e-dialog-dialogbutton></e-dialog-buttons></ejs-dialog>` |
...
| Event triggered after the dialog content loaded in DOM | **Event:** contentLoad<br/> <br/>`<ej-dialog id="dialog" content-load="onLoad"></ej-dialog>`<br/><br/>`function onLoad(args) {}`<br/> | Not Applicable |
| Event triggered when fails to load ajax content | **Event:** ajaxError<br/> <br/>`<ej-dialog id="dialog" ajax-error="onAjaxError"></ej-dialog>`<br/><br/>`function onAjaxError(args) {}`<br/> | Not Applicable |
| Event triggered when load ajax content successfully | **Event:** ajaxSuccess<br/> <br/>`<ej-dialog id="dialog" ajax-success="onAjaxSuccess"></ej-dialog>`<br/><br/>`function onAjaxSuccess(args) {}`<br/> | Not Applicable |
...
| Event triggered when the user drags the dialog | **Event:** drag<br/> <br/>`<ej-dialog id="dialog" drag="onDrag"></ej-dialog>`<br/><br/>`function onDrag(args) {}`<br/> | **Event:** drag<br/> <br/>`<ejs-dialog id="dialog" drag="onDrag"></ejs-dialog>`<br/><br/>`function onDrag(args) {}`<br/> |
| Event triggered when the dialog drag starts | **Event:** dragStart <br/> <br/>`<ej-dialog id="dialog" drag-start="onDragStart"></ej-dialog>`<br/><br/>`function onDragStart(args) {}`<br/> | **Event:** dragStart <br/><br/>`<ejs-dialog id="dialog" dragStart="onDragStart"></ejs-dialog>`<br/><br/>`function onDragStart(args) {}`<br/> |
| Event triggered when the dialog drag stops | **Event:** dragStop<br/> <br/>`<ej-dialog id="dialog" drag-stop="onDragStop"></ej-dialog>`<br/><br/>`function onDragStop(args) {}`<br/> | **Event:** dragStop<br/><br/>`<ejs-dialog id="dialog" dragStop="onDragStop"></ejs-dialog>`<br/><br/>`function onDragStop(args) {}` <br/> |
| Resizing dialog | **Property** : enableResize<br/> <br/>`<ej-dialog id="dialog" enable-resize="true" ></ej-dialog>` | Not Applicable |
| Event triggered when resizing the dialog | **Event:** resize <br/> <br/>`<ej-dialog id="dialog" resize="onReSize"></ej-dialog>`<br/><br/>`function onReSize(args) {}`<br/> | Not Applicable |
| Event triggered when resizing the dialog is started | **Event:** resizeStart<br/><br/>`<ej-dialog id="dialog" resize-start="onResizeStart"></ej-dialog>`<br/><br/>`function onResizeStart(args) {}`<br/> | Not Applicable |
| Event triggered when resizing the dialog is stopped | **Event:** resizeStop<br/><br/>`<ej-dialog id="dialog" resize-stop="onResizeStop"></ej-dialog>`<br/><br/>`function onResizeStop(args) {}`<br/> | Not Applicable |
...
| Event triggered before the dialog closes | **Event:** beforeClose <br/> <br/>`<ej-dialog id="dialog" before-close="onBeforeClose"></ej-dialog>`<br/><br/>`function onBeforeClose(args) {}` <br/> | **Event:** beforeClose <br/> <br/>`<ejs-dialog id="dialog" beforeClose="onBeforeClose"></ejs-dialog>`<br/><br/>`function onBeforeClose(args) {}`<br/> |
| Event triggered when the dialog closes | **Event:** close <br/> <br/>`<ej-dialog id="dialog" close="onClose"></ej-dialog>`<br/><br/>`function onClose(args) {}` <br/> | **Event:** close <br/><br/>`<ejs-dialog id="dialog" close="onClose"></ejs-dialog>`<br/><br/>`function onClose(args) {}` <br/> |
...
| Event triggered before the dialog opens | **Event:** beforeOpen <br/><br/> `<ej-dialog id="dialog" before-open="onBeforeOpen"></ej-dialog>`<br/><br/>`function onBeforeOpen(args) {}` <br/> | **Event:** beforeOpen <br/><br/>`<ejs-dialog id="dialog" beforeOpen="onBeforeOpen"></ejs-dialog>`<br/><br/>`function onBeforeOpen(args) {}` <br/> |
| Event triggered when the dialog opens | **Event:** open <br/> <br/> `<ej-dialog id="dialog" open="onOpen"></ej-dialog>`<br/><br/>`function onOpen(args) {}` <br/> | Event: open  <br/><br/>`<ejs-dialog id="dialog" open="onOpen"></ejs-dialog>`<br/><br/>`function onOpen(args) {}` <br/> |
...
| Event triggered after the dialog is created successfully | **Event:** create <br/><br/>`<ej-dialog id="dialog" create="onCreate"></ej-dialog>`<br/><br/>`function onCreate(args) {}` <br/> | **Event** : created <br/> <br/>`<ejs-dialog id="dialog" created="onCreated"></ejs-dialog>`<br/><br/>`function onCreated(args) {}` <br/> |
| Event triggered when the control is destroyed successfully | **Event:** destroy <br/><br/>`<ej-dialog id="dialog" destroy="onDestroy"></ej-dialog>`<br/><br/>`function onDestroy(args) {}` <br/> | Not Applicable |
| Event triggered on clicking on modal dialog overlay | **Not Applicable** | **Event** : overlayClick <br/><br/>`<ejs-dialog id="dialog" overlayClick="onOverlayClick"></ejs-dialog>`<br/><br/>`function onOverlayClick(args) {}`<br/> |