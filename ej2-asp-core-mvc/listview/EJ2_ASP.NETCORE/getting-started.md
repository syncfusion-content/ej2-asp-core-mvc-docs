...
This section briefly explains about how to include [ASP.NET Core ListView](https://www.syncfusion.com/aspnet-core-ui-controls/listview) control in your ASP.NET Core application using Visual Studio.
...
Now, add the ASP.NET Core ListView tag helper in **~/Pages/Index.cshtml** page.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the ASP.NET Core ListView control will be rendered in the default web browser.
