...
This section briefly explains how to include [ASP.NET Core ListView](https://www.syncfusion.com/aspnet-core-ui-controls/listview) control in your ASP.NET Core application using Visual Studio.
