...
To add [ASP.NET Core ListView](https://www.syncfusion.com/aspnet-core-ui-controls/listview) control in the app, open the NuGet package manager in Visual Studio (*Tools → NuGet Package Manager → Manage NuGet Packages for Solution*), search for and install the [Syncfusion.AspNetCore.Lists](https://www.nuget.org/packages/Syncfusion.AspNetCore.Lists/) and [Syncfusion.AspNetCore.Themes](https://www.nuget.org/packages/Syncfusion.AspNetCore.Themes/) packages. All Syncfusion ASP.NET Core packages are available in [nuget.org](https://www.nuget.org/packages?q=syncfusion.EJ2). See the [NuGet packages](https://ej2.syncfusion.com/aspnetcore/documentation/nuget-packages) topic for details.
...
Install-Package Syncfusion.AspNetCore.Lists -Version {{ site.releaseversion }}
...
@addTagHelper *, Syncfusion.AspNetCore.Lists
...
## Add ASP.NET Core ListView control

Add the [ASP.NET Core ListView](https://www.syncfusion.com/aspnet-core-ui-controls/listview) control in the **~/Pages/Index.cshtml** page.
...
After initialization, populate the ListView with data using the [`dataSource`](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Lists.ListView.html#Syncfusion_EJ2_Lists_ListView_DataSource) property. Here, the JSON values are passed to the ListView control.
