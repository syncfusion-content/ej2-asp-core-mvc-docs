---
layout: post
title: Getting Started with ASP.NET Core ImageEditor Control | Syncfusion
description: Checkout and learn about getting started with ASP.NET Core Image Editor control of Syncfusion Essential JS 2 and more details.
...
# Getting Started with ASP.NET Core Image Editor Control

This section briefly explains how to include the [ASP.NET Core Image Editor](https://www.syncfusion.com/aspnet-core-ui-controls/image-editor) control in your ASP.NET Core application using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
To add [ASP.NET Core Image Editor](https://www.syncfusion.com/aspnet-core-ui-controls/image-editor) control in the app, open the NuGet package manager in Visual Studio *(Tools → NuGet Package Manager → Manage NuGet Packages for Solution)*, search for and install the [Syncfusion.AspNetCore.ImageEditor](https://www.nuget.org/packages/Syncfusion.AspNetCore.ImageEditor) and [Syncfusion.AspNetCore.Themes](https://www.nuget.org/packages/Syncfusion.AspNetCore.Themes) packages. All Syncfusion ASP.NET Core packages are available on [nuget.org](https://www.nuget.org/packages?q=syncfusion.EJ2). See the [NuGet packages](https://ej2.syncfusion.com/aspnetcore/documentation/nuget-packages) topic for details.
...
Install-Package Syncfusion.AspNetCore.ImageEditor -Version {{ site.releaseversion }}
...
After the packages are installed, open the **~/Pages/_ViewImports.cshtml** file and import the `Syncfusion.AspNetCore.Base` and `Syncfusion.AspNetCore.ImageEditor` Tag Helpers.

{% tabs %}
{% highlight cshtml tabtitle="_ViewImports.cshtml" %}

@addTagHelper *, Syncfusion.AspNetCore.Base
@addTagHelper *, Syncfusion.AspNetCore.ImageEditor
...
## Add ASP.NET Core Image Editor Control

Add the [ASP.NET Core Image Editor](https://www.syncfusion.com/aspnet-core-ui-controls/image-editor) control in the **~/Pages/Index.cshtml** file.
