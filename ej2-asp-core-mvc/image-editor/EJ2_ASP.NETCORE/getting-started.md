...
This section briefly explains about how to include [ASP.NET Core Image Editor](https://www.syncfusion.com/aspnet-core-ui-controls/image-editor) control in your ASP.NET Core application using Visual Studio.
