...
description: Mark individual Syncfusion ##Platform_Name## ComboBox items as unselectable by mapping the disabled field in the data source to fields.disabled.
