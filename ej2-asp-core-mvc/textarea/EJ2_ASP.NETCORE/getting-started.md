...
This section briefly explains how to include the [ASP.NET Core TextArea](https://www.syncfusion.com/aspnet-core-ui-controls/textarea) control in an ASP.NET Core application using Visual Studio.
