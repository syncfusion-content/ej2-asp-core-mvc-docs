...
To add [ASP.NET Core TextArea](https://www.syncfusion.com/aspnet-core-ui-controls/textarea) control in the app, open the NuGet package manager in Visual Studio *(Tools → NuGet Package Manager → Manage NuGet Packages for Solution)*, search for and install the [Syncfusion.AspNetCore.Inputs](https://www.nuget.org/packages/Syncfusion.AspNetCore.Inputs/) and [Syncfusion.AspNetCore.Themes](https://www.nuget.org/packages/Syncfusion.AspNetCore.Themes/) packages. All Syncfusion ASP.NET Core packages are available on [nuget.org](https://www.nuget.org/packages?q=syncfusion.EJ2). See the [NuGet packages](https://ej2.syncfusion.com/aspnetcore/documentation/nuget-packages) topic for details.
...
## Add ASP.NET Core TextArea control

Add the [ASP.NET Core TextArea](https://www.syncfusion.com/aspnet-core-ui-controls/textarea) control in the **~/Pages/Index.cshtml** file.

{% tabs %}
{% highlight razor tabtitle="Index.cshtml" %}
{% include code-snippet/textarea/getting-started/textarea/tagHelper %}
{% endhighlight %}
{% endtabs %}

## Run the application

Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [ASP.NET Core TextArea](https://www.syncfusion.com/aspnet-core-ui-controls/textarea) control will render in your default web browser.

![ASP.NET Core TextArea Control](images/textarea-control.webp)
...
{% tabs %}
{% highlight razor tabtitle="Index.cshtml" %}
{% include code-snippet/textarea/getting-started/set-value1/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="Index.cshtml" %}
{% include code-snippet/textarea/getting-started/set-value2/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="Index.cshtml" %}
{% include code-snippet/textarea/getting-started/get-value1/tagHelper %}
{% endhighlight %}
{% endtabs %}
