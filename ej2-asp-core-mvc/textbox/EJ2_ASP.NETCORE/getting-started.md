...
This section briefly explains how to include the [ASP.NET Core TextBox](https://www.syncfusion.com/aspnet-core-ui-controls/textbox) control in an ASP.NET Core application using Visual Studio.
