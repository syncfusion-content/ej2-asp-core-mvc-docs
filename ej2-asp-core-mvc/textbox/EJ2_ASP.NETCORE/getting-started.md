---
layout: post
title: Getting Started with ASP.NET Core TextBox Component | Syncfusion
description: Checkout and learn about getting started with ASP.NET Core TexBox control of Syncfusion Essential JS 2 and more details.
...
This section briefly explains about how to include [ASP.NET Core TextBox](https://www.syncfusion.com/aspnet-core-ui-controls/textbox) control in your ASP.NET Core application using Visual Studio.
...
![ASP.NET Core TextBox Control](images/textbox-control.png)
...
N> You can also explore our [ASP.NET Core Textbox Example](https://ej2.syncfusion.com/aspnetcore/TextBoxes/DefaultFunctionalities#/bootstrap5) that shows you how to render the Textbox in ASP.NET Core.