---
layout: post
title: Getting Started with ASP.NET Core TextBox | Syncfusion
description: Learn how to get started with the Syncfusion ASP.NET Core TextBox control. Explore setup, features, examples, and customization options.
...
This section briefly explains how to include the [ASP.NET Core TextBox](https://www.syncfusion.com/aspnet-core-ui-controls/textbox) control in your ASP.NET Core application using [Visual Studio](https://visualstudio.microsoft.com/vs/).
...
To add [ASP.NET Core TextBox](https://www.syncfusion.com/aspnet-core-ui-controls/textbox) control in the app, open the NuGet package manager in Visual Studio *(Tools → NuGet Package Manager → Manage NuGet Packages for Solution)*, search for and install the [Syncfusion.AspNetCore.Inputs](https://www.nuget.org/packages/Syncfusion.AspNetCore.Inputs/) and [Syncfusion.AspNetCore.Themes](https://www.nuget.org/packages/Syncfusion.AspNetCore.Themes/) packages. All Syncfusion ASP.NET Core packages are available on [nuget.org](https://www.nuget.org/packages?q=syncfusion.EJ2). See the [NuGet packages](https://ej2.syncfusion.com/aspnetcore/documentation/nuget-packages) topic for details.
...
Add the [ASP.NET Core TextBox](https://www.syncfusion.com/aspnet-core-ui-controls/textbox) control in the **~/Pages/Index.cshtml** file.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [ASP.NET Core TextBox](https://www.syncfusion.com/aspnet-core-ui-controls/textbox) control will render in your default web browser.

![ASP.NET Core TextBox Control](images/textbox-control.webp)
...
![ASP.NET Core TextBox with Icon](images/textbox-getting.webp)
...
![ASP.NET Core TextBox with Floating Label](images/textbox-with-floating-label.webp)

N> [View Sample in GitHub](https://github.com/SyncfusionExamples/ASP-NET-Core-Getting-Started-Examples/tree/main/TextBox/ASP.NET%20Core%20Tag%20Helper%20Examples).
...
3. [How to render TextBox programmatically](./how-to/add-textbox-programmatically)
4. [How to add floating label to TextBox programmatically](./how-to/add-floating-label-to-textbox-programmatically)
