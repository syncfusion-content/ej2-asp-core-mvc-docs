---
layout: post
title: Migration from CSS TextBox to ASP.NET Core TextBox | Syncfusion
description: Migrate from CSS-based ASP.NET Core TextBox to the TagHelper control for floating labels, clear buttons, and validation states in a unified API.
...
# Migration from CSS TextBox to ASP.NET Core TextBox
