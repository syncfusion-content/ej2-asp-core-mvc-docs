...
You can change the default filter operator by extending [`filterModule.filterOperators`](https://help.syncfusion.com/grid-sdk/asp-net-mvc/tree-grid/filtering/filtering#filter-operators) property in [`dataBound`](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.TreeGrid.TreeGrid.html#Syncfusion_EJ2_TreeGrid_TreeGrid_DataBound) event.
