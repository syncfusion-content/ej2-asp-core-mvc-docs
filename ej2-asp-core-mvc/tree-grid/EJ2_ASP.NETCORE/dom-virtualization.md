...
To enable DOM virtualization in the ##Platform_Name## Tree Grid, you need to inject the **DomVirtualization** module. This module is responsible for managing the DOM pooling behavior and optimizing the rendering of data to enhance performance.

DOM virtualization can be enabled by setting the [enableDomVirtualization](../../api/treegrid#enabledomvirtualization) property to `true`. 

{% if page.publishingplatform == "aspnet-core" %}
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
<ejs-treegrid id="TreeGrid" enableDomVirtualization="true" height="500" childMapping="subtasks" dataSource="@ViewBag.data">
	<e-treegrid-columns>
...
@(Html.EJS().TreeGrid("TreeGrid")
	...
	.Columns(columns =>
	{
		columns.Field("taskID").HeaderText("Task ID").Width(100).Add();
		columns.Field("taskName").HeaderText("Task Name").Width(150).Add();
	})
	.Render())
{% endhighlight %}
{% endtabs %}
...
You must define a fixed height using the [height](../../api/treegrid#height) property in the Tree Grid configuration. The height property is mandatory for DOM virtualization because:
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/tree-grid/dom-virtual/domvirtualization1/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="domvirtualization1.cs" %}
{% include code-snippet/tree-grid/dom-virtual/domvirtualization1/domvirtualization1.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/tree-grid/dom-virtual/domvirtualization2/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="domvirtualization2.cs" %}
{% include code-snippet/tree-grid/dom-virtual/domvirtualization2/domvirtualization2.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/tree-grid/dom-virtual/domvirtualization2/razor %}
{% endhighlight %}
{% highlight c# tabtitle="domvirtualization2.cs" %}
{% include code-snippet/tree-grid/dom-virtual/domvirtualization2/domvirtualization2.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
<ejs-treegrid id="TreeGrid" enableDomVirtualization="true" setRowHeight="setRowHeight" height="500" dataSource="@ViewBag.data">
</ejs-treegrid>
...
Tree Grids handling very large row counts have specific characteristics:
