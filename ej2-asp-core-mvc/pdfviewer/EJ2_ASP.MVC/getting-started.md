---
layout: post
title: Getting Started with Pdfviewer Control in EJ2 ASP.NET Core | Syncfusion
description: Checkout and learn about how to include PdfViewer control in EJ2 ASP.NET MVC application.
