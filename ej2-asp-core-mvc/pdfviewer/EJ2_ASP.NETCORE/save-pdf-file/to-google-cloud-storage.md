---
layout: post
title: Save PDF files from Google Cloud Storage in  EJ2 ASP.NET CORE PDF Viewer | Syncfusion
description: Learn here all about how to Save PDF files from Google Cloud Storage in ASP.NET CORE PDF Viewer component of Syncfusion Essential JS 2 and more.
