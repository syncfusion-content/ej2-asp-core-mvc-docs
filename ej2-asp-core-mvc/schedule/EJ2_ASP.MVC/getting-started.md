...
This section briefly explains about how to include [ASP.NET MVC Scheduler](https://www.syncfusion.com/scheduler-sdk/asp-net-mvc-scheduler) control in your ASP.NET MVC application using Visual Studio.
