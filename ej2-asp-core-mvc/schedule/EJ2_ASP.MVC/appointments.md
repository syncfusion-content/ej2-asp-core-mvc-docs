...
description: Learn here all about Appointments of Syncfusion Essential ##Platform_Name## widgets based on HTML5 and jQuery.
...
{% aspTab template="schedule/appointments/inline-spanned-event", sourceFiles="data.cs"  %}
