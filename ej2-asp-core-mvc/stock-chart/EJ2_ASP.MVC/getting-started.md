...
This section briefly explains how to add the Syncfusion [ASP.NET MVC Stock Chart](https://www.syncfusion.com/aspnet-mvc-ui-controls/stock-chart) control to your ASP.NET MVC application using Visual Studio.
...
This section explains how to plot JSON data in the ASP.NET MVC Stock Chart.
