...
{% include code-snippet/stock-chart/gradient/series-linear/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/stock-chart/gradient/series-linear/razor %}
{% endhighlight %}
{% highlight c# tabtitle="LinearGradient.cs" %}
{% include code-snippet/stock-chart/gradient/series-linear/series-linear.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/stock-chart/gradient/indicators-linear/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="LinearGradient.cs" %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/stock-chart/gradient/indicators-linear/razor %}
{% endhighlight %}
{% highlight c# tabtitle="LinearGradient.cs" %}
{% include code-snippet/stock-chart/gradient/indicators-linear/indicators-linear.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/stock-chart/gradient/series-radial/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/stock-chart/gradient/series-radial/razor %}
{% endhighlight %}
{% highlight c# tabtitle="RadialGradient.cs" %}
{% include code-snippet/stock-chart/gradient/series-radial/series-radial.cs %}
{% endhighlight %}
