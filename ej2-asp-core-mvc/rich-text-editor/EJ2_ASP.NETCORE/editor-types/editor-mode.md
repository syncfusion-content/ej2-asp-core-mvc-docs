---
layout: post
title: Editor Modes in ##Platform_Name## Syncfusion Rich Text Editor Component
...
Set the [editorMode](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.RichTextEditor.RichTextEditor.html#Syncfusion_EJ2_RichTextEditor_RichTextEditor_EditorMode) property value as `Markdown` to create or edit the content and apply formatting to view markdown formatted content.
