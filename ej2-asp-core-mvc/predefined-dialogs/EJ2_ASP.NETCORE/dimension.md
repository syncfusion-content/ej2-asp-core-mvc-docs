...
description: Learn how to customize dimensions in ##Platform_Name## Predefined Dialogs using width, height, min-width, min-height, max-width, and max-height settings.
