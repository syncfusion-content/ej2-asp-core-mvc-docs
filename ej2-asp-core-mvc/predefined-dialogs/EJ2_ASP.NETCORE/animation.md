...
description: Learn how to configure animation in ##Platform_Name## Predefined Dialogs using animationSettings, including delay, duration, and animation effects.
