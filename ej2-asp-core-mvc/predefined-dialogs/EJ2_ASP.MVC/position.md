...
![ASP.NET MVC Predefinded Dialogs Alert position Dialog](./images/asp-core-mvc-predefinded-dialogs-alert-position.png)

**Confirm**

![ASP.NET MVC Predefinded Dialogs Confirm position Dialog](./images/asp-core-mvc-predefinded-dialogs-confirm-position.png)

**Prompt**

![ASP.NET MVC Predefinded Dialogs Prompt position Dialog](./images/asp-core-mvc-predefinded-dialogs-prompt-position.png)