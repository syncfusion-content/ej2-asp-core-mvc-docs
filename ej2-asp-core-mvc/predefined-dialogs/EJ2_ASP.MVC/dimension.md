...
description: Learn how to customize dimensions in ASP.NET MVC Predefined Dialogs using width, height, min-width, min-height, max-width, and max-height settings.
...
# Dimension in ASP.NET MVC Predefined Dialogs
