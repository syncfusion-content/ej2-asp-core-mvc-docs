...
description: Learn how to configure pane sizing in the Syncfusion ##Platform_Name## Splitter using pixel and percentage values, fixed panes, and auto-sized layouts.
