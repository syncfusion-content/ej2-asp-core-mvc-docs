...
description: Learn how to migrate Splitter APIs from Essential JS 1 to the Syncfusion ##Platform_Name## Splitter, including properties, methods, events, pane settings, accessibility, localization, and state management changes.
