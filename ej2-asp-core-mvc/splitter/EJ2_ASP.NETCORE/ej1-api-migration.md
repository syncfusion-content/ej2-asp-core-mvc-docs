...
description: Learn how to migrate Splitter APIs from Essential JS 1 to Syncfusion ##Platform_Name## Splitter, including properties, methods, events, accessibility, and localization.
