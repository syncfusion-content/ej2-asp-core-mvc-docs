...
description: Learn how to customize the appearance of the Syncfusion ##Platform_Name## Splitter by modifying split bars, resize handles, navigation arrows, and other visual elements using CSS.
