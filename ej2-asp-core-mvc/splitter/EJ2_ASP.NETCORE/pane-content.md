...
This section explains how to provide plain text content or HTML markup or integrate other ASP.NET Core UI controls as content of splitter.
...
You can render any ASP.NET Core UI controls along with their native and control events within splitter as pane content.
