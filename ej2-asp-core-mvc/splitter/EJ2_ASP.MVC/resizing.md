...
description: Learn how to resize panes in Syncfusion ##Platform_Name## Splitter, configure pane sizes, prevent resizing, and customize resize grips and cursors.
