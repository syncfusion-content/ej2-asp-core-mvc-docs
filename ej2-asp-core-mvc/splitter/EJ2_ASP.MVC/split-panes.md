...
description: Learn how to create and manage split panes in the Syncfusion ##Platform_Name## Splitter, including horizontal and vertical layouts, multiple panes, nested splitters, separator customization, and dynamic pane operations.
