...
Now, add the ASP.NET Core Calendar tag helper in `~/Views/Home/Index.cshtml` page.
...
* [Getting Started with ASP.NET Core MVC using HTML Helper](https://ej2.syncfusion.com/aspnetcore/documentation/getting-started/aspnet-core-mvc-htmlhelper)