...
## Add Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core namespace
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Calendar Html helper in `~/Views/Home/Index.cshtml` page.
