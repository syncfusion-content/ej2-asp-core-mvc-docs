...
# Downloading Syncfusion<sup>&reg;</sup> ASP.NET MVC EJ2 web installer
...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion<sup style="font-size:70%">&reg;</sup> Essential Studio<sup style="font-size:70%">&reg;</sup> ASP . NET MVC - EJ2 web installer.
...
8. After downloading, the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC EJ2 web installer can be unlocked using Syncfusion<sup style="font-size:70%">&reg;</sup> registered login credential.
