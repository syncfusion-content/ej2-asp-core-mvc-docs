...
**Solution:** Purchase from [here](https://www.syncfusion.com/sales/pricing?category=ui-components) to get a valid Syncfusion<sup style="font-size:70%">&reg;</sup> license.
