...
**Solution:** Purchase from [here](https://www.syncfusion.com/sales/pricing) to get a valid Syncfusion<sup style="font-size:70%">&reg;</sup> license.
...
**Error Message:** The included Syncfusion<sup style="font-size:70%">&reg;</sup> license ({Registered Version}) is invalid for version {Required Version}. Refer to this [help topic](https://ej2.syncfusion.com/aspnetmvc/documentation/licensing/licensing-errors#platform-mismatch) for more information.
