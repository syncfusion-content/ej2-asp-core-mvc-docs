...
# Syncfusion® AI Coding Assistant Overview in ASP.NET Core
...
* Add the [SyncfusionAspNetMvc MCP Server](https://ej2.syncfusion.com/aspnetmvc/documentation/ai-coding-assistant/mcp-server) to an MCP-enabled client
