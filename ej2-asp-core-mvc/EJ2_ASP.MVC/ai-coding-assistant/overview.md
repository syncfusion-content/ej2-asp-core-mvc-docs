...
* **The SyncfusionAspNetMvcAssistant MCP Server**
  Processes advanced prompts and returns tailored code suggestions via [MCP-compatible clients](https://modelcontextprotocol.io/docs/2026-07-28/develop/build-client).
...
* An [ASP.NET MVC application that includes SyncfusionAspNetMvc](https://ej2.syncfusion.com/aspnetmvc/documentation/getting-started/aspnet-mvc-htmlhelper)
...
* Add the [SyncfusionAspNetMvc MCP Server](https://ej2.syncfusion.com/aspnetmvc/documentation/mcp) to an MCP-enabled client
