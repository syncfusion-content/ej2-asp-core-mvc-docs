...
N> You can also explore our [ASP.NET Core Sparkline Chart example](https://ej2.syncfusion.com/aspnetcore/SparkLine/Default#/material) that shows you how to render and configure the Sparkline Chart in Core.
