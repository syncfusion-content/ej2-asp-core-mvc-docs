...
{% aspTab template="sparkline/getting-started/data-source", sourceFiles="data-source.cs" %}
...
{% aspTab template="sparkline/getting-started/type", sourceFiles="type.cs" %}
...
{% aspTab template="sparkline/getting-started/tooltip", sourceFiles="tooltip.cs" %}
