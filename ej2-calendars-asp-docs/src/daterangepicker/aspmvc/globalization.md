...
> The `Localization` library allows you to localize default text content of the DateRangePicker. The DateRangePicker control has static text for  **today** feature that can be changed to other cultures (Arabic, Deutsch, French, etc.) by defining the
...
{% aspTab template="daterangepicker/globalization/globalization" %}
...
{% aspTab template="daterangepicker/globalization/rtl" %}
