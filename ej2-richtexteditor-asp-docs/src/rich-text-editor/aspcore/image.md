---
title: "ASP.NET Core Rich Text Editor with image actions with upload"
...
> Note: The runnable demo application is available in this [Github](https://github.com/SyncfusionExamples/aspnet-core-richtexteditor-image-upload) repository.

{% aspTab template="rich-text-editor/save", sourceFiles="controller.cs" %}
