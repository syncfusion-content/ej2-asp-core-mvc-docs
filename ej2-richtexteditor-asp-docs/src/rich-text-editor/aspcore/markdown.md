...
description: "This section for Syncfusion ASP.NET CORE Rich Text Editor control explains the markdown editing and custom formatting."
---
...
{% aspTab template="rich-text-editor/markdown", sourceFiles="controller.cs" %}
...
{% aspTab template="rich-text-editor/markdown-table", sourceFiles="controller.cs" %}
...
{% aspTab template="rich-text-editor/markdown-table-constants", sourceFiles="controller.cs" %}
