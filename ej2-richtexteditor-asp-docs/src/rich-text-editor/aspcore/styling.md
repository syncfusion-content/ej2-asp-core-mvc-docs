...
description: "This section for Syncfusion ASP.NET CORE Rich Text Editor control explains on how to format text, paragraphs, characters with the toolbar items."
---
...
{% aspTab template="rich-text-editor/styling", sourceFiles="controller.cs" %}
...
{% aspTab template="rich-text-editor/custom-style", sourceFiles="controller.cs" %}
...
{% aspTab template="rich-text-editor/custom-font", sourceFiles="controller.cs" %}
